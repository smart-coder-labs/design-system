import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DuoaHqPM.js";import{t as r}from"./jsx-runtime-BscHEzdU.js";import{n as i,t as a}from"./utils-COD7dmCP.js";import{Tn as o,Yn as s,kn as c,nt as l,t as u}from"./lucide-react-Js4yG5Ra.js";import{t as d}from"./Input-BYVaDk4p.js";import{t as f}from"./Input-FZ8_2E-2.js";import{n as p,t as m}from"./Button-Cafbi4DX.js";var h,g,_,v=e((()=>{h=t(n()),i(),m(),f(),u(),g=r(),_=({defaultValue:e=`https://example.com`,size:t=200,color:n=`#000000`,backgroundColor:r=`#FFFFFF`,showInput:i=!1,className:u})=>{let[f,m]=(0,h.useState)(e),[_,v]=(0,h.useState)(``),[y,b]=(0,h.useState)(!0),[x,S]=(0,h.useState)(!1),C=e=>e.replace(`#`,``);return(0,h.useEffect)(()=>{b(!0);let e=`https://api.qrserver.com/v1/create-qr-code/?size=${t}x${t}&data=${encodeURIComponent(f)}&color=${C(n)}&bgcolor=${C(r)}&margin=10`,i=new Image;i.src=e,i.onload=()=>{v(e),b(!1)}},[f,t,n,r]),(0,g.jsxs)(`div`,{className:a(`flex flex-col items-center gap-6 p-6 rounded-2xl bg-surface-primary border border-border-primary shadow-sm w-full max-w-sm`,u),children:[i&&(0,g.jsxs)(`div`,{className:`w-full space-y-2`,children:[(0,g.jsx)(`label`,{className:`text-sm font-medium text-text-secondary`,children:`Content`}),(0,g.jsx)(d,{value:f,onChange:e=>m(e.target.value),placeholder:`Enter URL or text...`,className:`w-full`})]}),(0,g.jsxs)(`div`,{className:`relative rounded-xl overflow-hidden bg-white shadow-inner border border-border-secondary`,style:{width:t,height:t},children:[y&&(0,g.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center bg-surface-secondary animate-pulse`,children:(0,g.jsx)(l,{className:`w-8 h-8 text-text-tertiary animate-spin`})}),_&&(0,g.jsx)(`img`,{src:_,alt:`QR Code`,className:a(`w-full h-full object-contain transition-opacity duration-300`,y?`opacity-0`:`opacity-100`)})]}),(0,g.jsxs)(`div`,{className:`flex items-center gap-2 w-full`,children:[(0,g.jsxs)(p,{variant:`outline`,className:`flex-1`,onClick:()=>{navigator.clipboard.writeText(f),S(!0),setTimeout(()=>S(!1),2e3)},title:`Copy content to clipboard`,children:[x?(0,g.jsx)(s,{className:`w-4 h-4 mr-2`}):(0,g.jsx)(c,{className:`w-4 h-4 mr-2`}),x?`Copied`:`Copy`]}),(0,g.jsxs)(p,{variant:`primary`,className:`flex-1`,onClick:async()=>{try{let e=await(await fetch(_)).blob(),t=window.URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`qrcode-${Date.now()}.png`,document.body.appendChild(n),n.click(),document.body.removeChild(n),window.URL.revokeObjectURL(t)}catch(e){console.error(`Error downloading QR code:`,e),window.open(_,`_blank`)}},children:[(0,g.jsx)(o,{className:`w-4 h-4 mr-2`}),`Download`]})]})]})},_.__docgenInfo={description:``,methods:[],displayName:`QRCodeGenerator`,props:{defaultValue:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`"https://example.com"`,computed:!1}},size:{required:!1,tsType:{name:`number`},description:``,defaultValue:{value:`200`,computed:!1}},color:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`"#000000"`,computed:!1}},backgroundColor:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`"#FFFFFF"`,computed:!1}},showInput:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},className:{required:!1,tsType:{name:`string`},description:``}}}})),y,b,x,S,C,w,T,E,D,O,k;e((()=>{v(),y={title:`Data Display/QRCodeGenerator`,component:_,tags:[`autodocs`]},b={args:{value:`https://example.com`}},x={args:{value:`bitcoin:bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh?amount=0.01`,label:`Bitcoin Address`}},S={args:{value:`0x1234567890abcdef1234567890abcdef12345678`,label:`Ethereum Address`}},C={args:{value:`https://app.cryptowallet.com/referral?code=ABC123`,size:256,label:`Referral Link`}},w={args:{value:`payment-12345`,size:128,label:`Payment Code`}},T={args:{defaultValue:`https://pay.bank.com/send?to=123456&amount=50.00`,size:200,showInput:!1,label:`Scan to Pay $50 USD`}},E={args:{defaultValue:`bitcoin:1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa?amount=0.01`,size:200,showInput:!1,label:`Bitcoin Receiving Address`}},D={args:{defaultValue:`https://fintech.app/profile/cesar`,size:180,color:`#007AFF`,backgroundColor:`#F2F2F7`,showInput:!0,label:`Profile QR Code`}},O={args:{defaultValue:`https://banking.app/invite/referral?code=CESAR2026`,size:300,showInput:!1,label:`Referral Code`}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
