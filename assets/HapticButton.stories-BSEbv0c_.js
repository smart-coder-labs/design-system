...
| 'selection'
| 'impact'
| 'notification'`,elements:[{name:`literal`,value:`'light'`},{name:`literal`,value:`'medium'`},{name:`literal`,value:`'heavy'`},{name:`literal`,value:`'success'`},{name:`literal`,value:`'warning'`},{name:`literal`,value:`'error'`},{name:`literal`,value:`'selection'`},{name:`literal`,value:`'impact'`},{name:`literal`,value:`'notification'`}]},{name:`boolean`}]},description:``,defaultValue:{value:`'medium'`,computed:!1}},hapticOnHover:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},hapticOnTap:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`true`,computed:!1}}},composes:[`Omit`]}})),v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{n(),_(),s(),v=l(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`Buttons/HapticButton`,component:g,tags:[`autodocs`],parameters:{layout:`centered`}},x={args:{children:`Send Payment`,onClick:y(`clicked`),variant:`primary`}},S={args:{children:`Cancel`,onClick:y(`clicked`),variant:`secondary`}},C={args:{children:`Learn More`,onClick:y(`clicked`),variant:`ghost`}},w={args:{children:`Delete Account`,onClick:y(`clicked`),variant:`danger`}},T={args:{children:`Confirm Payment`,onClick:y(`clicked`),size:`lg`,icon:(0,v.jsx)(c,{className:`w-5 h-5`})}},E={args:{children:`Send`,onClick:y(`clicked`),size:`sm`}},D={args:{children:`Send`,onClick:y(`clicked`),disabled:!0}},O={args:{children:`Send Money`,onClick:y(`clicked`),icon:(0,v.jsx)(a,{className:`w-4 h-4`}),variant:`primary`}},k={args:{children:`Processing`,onClick:y(`clicked`),loading:!0,variant:`primary`}},A={args:{children:`Confirm $250.00 Payment`,onClick:y(`clicked`),variant:`primary`,fullWidth:!0,icon:(0,v.jsx)(c,{className:`w-4 h-4`})},decorators:[e=>(0,v.jsx)(`div`,{className:`w-80`,children:(0,v.jsx)(e,{})})]},j={render:()=>(0,v.jsxs)(`div`,{className:`w-80 space-y-3`,children:[(0,v.jsx)(`p`,{className:`text-sm font-semibold text-text-primary`,children:`Complete Payment`}),(0,v.jsx)(g,{variant:`primary`,fullWidth:!0,icon:(0,v.jsx)(r,{className:`w-4 h-4`}),onClick:y(`pay`),children:`Pay $250.00`}),(0,v.jsx)(g,{variant:`secondary`,fullWidth:!0,icon:(0,v.jsx)(o,{className:`w-4 h-4`}),onClick:y(`wallet`),children:`Pay with Wallet`}),(0,v.jsx)(g,{variant:`ghost`,fullWidth:!0,onClick:y(`cancel`),children:`Cancel`})]})},M={decorators:[e=>(0,v.jsx)(`div`,{className:`p-8 bg-gray-900 rounded-2xl`,children:(0,v.jsx)(e,{})})],args:{children:`Continue`,onClick:y(`clicked`),variant:`primary`,icon:(0,v.jsx)(i,{className:`w-4 h-4`})}},N={args:{children:`Approve recurring transfer of $150.00 every month`,onClick:y(`clicked`),variant:`primary`}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
