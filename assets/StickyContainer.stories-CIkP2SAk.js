import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as m}from"./utils-DCADjnpI.js";const t=({children:s,top:n=0,zIndex:c=20,className:d,style:l})=>e.jsx("div",{className:m("sticky","bg-surface-secondary/80 backdrop-blur-xl border border-border-primary shadow-sm","rounded-xl","px-4 py-2",d),style:{top:n,zIndex:c,...l},children:s});t.__docgenInfo={description:`StickyContainer: Apple/macOS style sticky surface
