import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DuoaHqPM.js";import{t as r}from"./jsx-runtime-BscHEzdU.js";import{l as i,s as a,t as o}from"./es-lKEstbry.js";import{n as s,t as c}from"./utils-COD7dmCP.js";import{$n as l,K as u,Mt as d,On as f,Qt as p,W as m,ft as h,pr as g,s as _,t as v,v as y,z as b}from"./lucide-react-Js4yG5Ra.js";var x,S,C,w=e((()=>{x=t(n()),o(),s(),S=r(),C=x.forwardRef(({isOpen:e,onClose:t,position:n=`left`,sections:r=[],header:o,footer:s,width:l=`md`,showBackdrop:u=!0,closeOnBackdropClick:d=!0,belowNavBar:f=!1,navBarHeight:p=56,className:m=``,...h},g)=>{let _={sm:`w-64`,md:`w-80`,lg:`w-96`},v={left:{hidden:{x:`-100%`},visible:{x:0},exit:{x:`-100%`}},right:{hidden:{x:`100%`},visible:{x:0},exit:{x:`100%`}}},y={hidden:{opacity:0},visible:{opacity:1},exit:{opacity:0}},b=`
        ...
        `,C=c(`fixed bg-black/40 backdrop-blur-sm`,f?`z-dropdown`:`z-modal`,!f&&`inset-0`),w=f?{top:`${p}px`,height:`calc(100vh - ${p}px)`}:{top:0,height:`100vh`},T=f?{top:`${p}px`,left:0,right:0,bottom:0}:{};return x.useEffect(()=>(e?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[e]),x.useEffect(()=>{let n=n=>{n.key===`Escape`&&e&&t()};return document.addEventListener(`keydown`,n),()=>document.removeEventListener(`keydown`,n)},[e,t]),(0,S.jsx)(i,{children:e&&(0,S.jsxs)(S.Fragment,{children:[u&&(0,S.jsx)(a.div,{className:C,style:T,variants:y,initial:`hidden`,animate:`visible`,exit:`exit`,transition:{duration:.2},onClick:()=>{d&&t()},"aria-hidden":`true`}),(0,S.jsxs)(a.div,{ref:g,className:c(b,m),style:w,variants:v[n],initial:`hidden`,animate:`visible`,exit:`exit`,transition:{type:`spring`,stiffness:300,damping:30},role:`dialog`,"aria-modal":`true`,...h,children:[o&&(0,S.jsx)(`div`,{className:`flex-shrink-0 px-4 py-4 border-b border-border-primary`,children:o}),(0,S.jsx)(`div`,{className:`flex-1 overflow-y-auto px-2 py-4`,children:r.map((e,t)=>(0,S.jsxs)(`div`,{className:`mb-6 last:mb-0`,children:[e.title&&(0,S.jsx)(`h3`,{className:`px-4 mb-2 text-xs font-semibold text-text-tertiary uppercase tracking-wide`,children:e.title}),(0,S.jsx)(`nav`,{className:`space-y-1`,children:e.items.map((e,t)=>{let n=e.href?`a`:`button`,r=!!e.active;return(0,S.jsxs)(n,{href:e.href,onClick:e.onClick,className:c(`
