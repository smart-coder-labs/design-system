import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as E,r as N}from"./iframe-B3ue83QT.js";import{c as M}from"./utils-CDN07tui.js";import{B as n}from"./Button-DObt_mRa.js";import{T as K}from"./triangle-alert-DqOMgyS7.js";import{m as Y}from"./proxy-f4HTbMBa.js";import{E as B}from"./eye-off-Cm4ZEqEI.js";import{E as P}from"./eye-Cjfw9jX-.js";import{C as I}from"./check-DcafJKeN.js";import{C as j}from"./copy-Dsg7rPgu.js";import{D as V}from"./download-RfLirCv0.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DEqxIg5F.js";const y=E.forwardRef(({codes:a,onCopy:h,onDownload:f,title:R="Recovery Codes",description:x="Save these codes in a safe place. You can use them to access your account if you lose your device.",showWarning:D=!0,className:b,...S},T)=>{const[W,C]=N.useState(null),[v,L]=N.useState(new Set),w=(o,s)=>{navigator.clipboard.writeText(o),C(s),setTimeout(()=>C(null),2e3),h?.(o)},k=o=>{L(s=>{const t=new Set(s);return t.has(o)?t.delete(o):t.add(o),t})},A=()=>{const o=a.join(`
