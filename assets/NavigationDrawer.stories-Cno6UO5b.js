import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as l}from"./iframe-B-5hg53G.js";import{c as N}from"./utils-CDN07tui.js";import{A as Z}from"./index-Bmz56CCF.js";import{m as C}from"./proxy-BFtQK4Qy.js";import{B as W}from"./Button-Dumis5Wa.js";import"./preload-helper-PPVm8Dsz.js";const v=l.forwardRef(({isOpen:s,onClose:i,position:o="left",sections:k=[],header:B,footer:O,width:T="md",showBackdrop:q=!0,closeOnBackdropClick:A=!0,belowNavBar:c=!1,navBarHeight:y=56,className:P="",...V},E)=>{const H={sm:"w-64",md:"w-80",lg:"w-96"},L={left:{hidden:{x:"-100%"},visible:{x:0},exit:{x:"-100%"}},right:{hidden:{x:"100%"},visible:{x:0},exit:{x:"100%"}}},F={hidden:{opacity:0},visible:{opacity:1},exit:{opacity:0}},z=`
