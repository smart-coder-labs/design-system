import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DL3IwwZJ.js";import{t as r}from"./jsx-runtime-BK76Wfr-.js";import{$n as i,K as a,Nn as o,Or as s,Q as c,Xt as l,Y as u,br as d,en as f,h as p,i as m,rr as h,t as g,vr as _,x as v,xt as y}from"./lucide-react-C3ayLXpj.js";var b,x,S,C=e((()=>{b=t(n()),g(),x=r(),S=({actions:e,position:t=`bottom`,variant:n=`default`,showLabels:r=!1,dismissible:a=!1,onDismiss:o,className:s=``,offset:c=24,defaultActiveId:l})=>{let[u,d]=(0,b.useState)(!0),[f,p]=(0,b.useState)(!1),[h,g]=(0,b.useState)(l);(0,b.useEffect)(()=>{p(!0);let e=setTimeout(()=>p(!1),300);return()=>clearTimeout(e)},[]);let _=()=>{d(!1),o?.()},v=()=>{d(!0)},y=e=>{g(e.id),e.onClick()},S={top:`top-0 left-1/2 -translate-x-1/2`,bottom:`bottom-0 left-1/2 -translate-x-1/2`,"top-left":`top-0 left-0`,"top-right":`top-0 right-0`,"bottom-left":`bottom-0 left-0`,"bottom-right":`bottom-0 right-0`},C={default:`bg-surface-primary border border-border-primary shadow-lg`,compact:`bg-surface-primary border border-border-primary shadow-md`,glass:`glass border border-border-primary shadow-xl`},w={top:f?`animate-slide-down`:``,bottom:f?`animate-slide-up`:``,"top-left":f?`animate-scale-in`:``,"top-right":f?`animate-scale-in`:``,"bottom-left":f?`animate-scale-in`:``,"bottom-right":f?`animate-scale-in`:``},T=(e,t)=>{if(t)return`text-accent-blue border-b-2 border-accent-blue`;switch(e){case`primary`:return`text-accent-blue hover:bg-accent-blue/10`;case`danger`:return`text-status-error hover:bg-status-error/10`;default:return`text-text-primary hover:bg-background-tertiary/50`}};return!u&&a?(0,x.jsx)(`div`,{className:`floating-toolbar-collapsed fixed ${S[t]} z-50 ${s}`,style:{margin:`${c}px`},children:(0,x.jsx)(`button`,{onClick:v,className:`${C[n]} rounded-full p-3 hover:scale-110 transition-all duration-200 animate-scale-in`,"aria-label":`Expand toolbar`,children:(0,x.jsx)(i,{className:`w-5 h-5 text-text-primary`})})}):(0,x.jsxs)(`div`,{className:`floating-toolbar fixed ${S[t]} ${w[t]} z-50 ${s}`,style:{margin:`${c}px`},children:[(0,x.jsxs)(`div`,{className:`toolbar-container ${C[n]} rounded-2xl ${n===`compact`?`p-1.5`:`p-2`} flex items-center gap-1`,children:[(0,x.jsx)(`div`,{className:`flex items-center gap-1`,children:e.map(e=>{let t=h===e.id;return(0,x.jsxs)(`button`,{onClick:()=>y(e),disabled:e.disabled,className:`toolbar-action relative flex items-center gap-2 ${n===`compact`?`px-2.5 py-2`:`px-3 py-2.5`} rounded-xl font-medium text-sm transition-all duration-200 ${T(e.variant,t)} disabled:opacity-40 disabled:cursor-not-allowed group`,title:e.tooltip||e.label,"aria-label":e.label||e.tooltip,"aria-pressed":t,children:[(0,x.jsx)(`span`,{className:`flex-shrink-0 w-5 h-5`,children:e.icon}),r&&e.label&&(0,x.jsx)(`span`,{className:`whitespace-nowrap`,children:e.label}),e.tooltip&&!r&&!t&&(0,x.jsxs)(`span`,{className:`tooltip absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-xs font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap pointer-events-none shadow-lg`,children:[e.tooltip,(0,x.jsx)(`span`,{className:`tooltip-arrow absolute top-full left-1/2 -translate-x-1/2 -mt-px border-4 border-transparent border-t-gray-900 dark:border-t-gray-100`})]})]},e.id)})}),a&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:`w-px h-6 bg-border-primary mx-1`}),(0,x.jsx)(`button`,{onClick:_,className:`dismiss-button flex items-center justify-center ${n===`compact`?`w-8 h-8`:`w-9 h-9`} rounded-xl text-text-secondary hover:text-text-primary hover:bg-background-tertiary/50 transition-all duration-200`,"aria-label":`Collapse toolbar`,children:(0,x.jsx)(m,{className:`w-4 h-4`})})]})]}),(0,x.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})},S.__docgenInfo={description:``,methods:[],displayName:`FloatingToolbar`,props:{actions:{required:!0,tsType:{name:`Array`,elements:[{name:`FloatingToolbarAction`}],raw:`FloatingToolbarAction[]`},description:``},position:{required:!1,tsType:{name:`union`,raw:`'top' | 'bottom' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right'`,elements:[{name:`literal`,value:`'top'`},{name:`literal`,value:`'bottom'`},{name:`literal`,value:`'top-left'`},{name:`literal`,value:`'top-right'`},{name:`literal`,value:`'bottom-left'`},{name:`literal`,value:`'bottom-right'`}]},description:``,defaultValue:{value:`'bottom'`,computed:!1}},variant:{required:!1,tsType:{name:`union`,raw:`'default' | 'compact' | 'glass'`,elements:[{name:`literal`,value:`'default'`},{name:`literal`,value:`'compact'`},{name:`literal`,value:`'glass'`}]},description:``,defaultValue:{value:`'default'`,computed:!1}},showLabels:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},dismissible:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},onDismiss:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},className:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`''`,computed:!1}},offset:{required:!1,tsType:{name:`number`},description:``,defaultValue:{value:`24`,computed:!1}},defaultActiveId:{required:!1,tsType:{name:`string`},description:``}}}})),w,T,E,D,O,k,A,j,M,N,P,F,I,L,R;e((()=>{n(),C(),g(),w=r(),{action:T}=__STORYBOOK_MODULE_ACTIONS__,E=[{id:`bold`,icon:(0,w.jsx)(d,{className:`w-4 h-4`}),label:`Bold`,onClick:T(`bold`),tooltip:`Bold (Ctrl+B)`},{id:`italic`,icon:(0,w.jsx)(l,{className:`w-4 h-4`}),label:`Italic`,onClick:T(`italic`),tooltip:`Italic (Ctrl+I)`},{id:`underline`,icon:(0,w.jsx)(p,{className:`w-4 h-4`}),label:`Underline`,onClick:T(`underline`),tooltip:`Underline (Ctrl+U)`},{id:`color`,icon:(0,w.jsx)(y,{className:`w-4 h-4`}),label:`Color`,onClick:T(`color`),tooltip:`Text color`},{id:`delete`,icon:(0,w.jsx)(v,{className:`w-4 h-4`}),label:`Delete`,onClick:T(`delete`),variant:`danger`,tooltip:`Delete`}],D={title:`Navigation/FloatingToolbar`,component:S,tags:[`autodocs`]},O={args:{actions:E,position:`bottom`}},k={args:{actions:E.slice(0,4),position:`top`}},A={args:{actions:E.slice(0,3),variant:`compact`}},j={args:{actions:E,variant:`glass`}},M={args:{actions:E.slice(0,3),showLabels:!0}},N={args:{actions:E.slice(0,3),dismissible:!0,onDismiss:T(`dismissed`)}},P={args:{actions:[{id:`send`,icon:(0,w.jsx)(u,{className:`w-4 h-4`}),label:`Send`,onClick:T(`send`),tooltip:`Send money`},{id:`request`,icon:(0,w.jsx)(s,{className:`w-4 h-4`}),label:`Request`,onClick:T(`request`),tooltip:`Request money`},{id:`scan`,icon:(0,w.jsx)(c,{className:`w-4 h-4`}),label:`Scan`,onClick:T(`scan`),tooltip:`Scan QR`},{id:`card`,icon:(0,w.jsx)(o,{className:`w-4 h-4`}),label:`Card`,onClick:T(`card`),tooltip:`Card payment`}],variant:`glass`,position:`top`,showLabels:!0}},F={args:{actions:[{id:`confirm`,icon:(0,w.jsx)(h,{className:`w-4 h-4`}),label:`Approve`,onClick:T(`approve`),variant:`success`},{id:`reject`,icon:(0,w.jsx)(m,{className:`w-4 h-4`}),label:`Reject`,onClick:T(`reject`),variant:`danger`,tooltip:`Reject transaction`},{id:`share`,icon:(0,w.jsx)(a,{className:`w-4 h-4`}),label:`Share`,onClick:T(`share`),tooltip:`Share receipt`},{id:`save`,icon:(0,w.jsx)(_,{className:`w-4 h-4`}),label:`Save`,onClick:T(`save`),tooltip:`Save reference`}],variant:`glass`,showLabels:!0}},I={args:{actions:[{id:`upload`,icon:(0,w.jsx)(f,{className:`w-4 h-4`}),label:`Upload`,onClick:T(`upload`)},{id:`bold`,icon:(0,w.jsx)(d,{className:`w-4 h-4`}),label:`Bold`,onClick:T(`bold`),disabled:!0},{id:`italic`,icon:(0,w.jsx)(l,{className:`w-4 h-4`}),label:`Italic`,onClick:T(`italic`),disabled:!0},{id:`delete`,icon:(0,w.jsx)(v,{className:`w-4 h-4`}),label:`Delete`,onClick:T(`delete`),variant:`danger`}],variant:`compact`,showLabels:!0}},L={args:{actions:[{id:`delete`,icon:(0,w.jsx)(v,{className:`w-4 h-4`}),label:`Delete`,onClick:T(`delete`),variant:`danger`,tooltip:`Delete item`}]}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  args: {
