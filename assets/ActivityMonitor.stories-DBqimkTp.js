...
}`,...$.parameters?.docs?.source}}};const Oe=["Default","CPU","Memory","Energy","Disk","Network","WithAutoRefresh","WithProcessSelection","SystemMonitoring","HighLoadScenario","LowLoadScenario","EmptyState","Playground"];export{R as CPU,C as Default,A as Disk,q as EmptyState,I as Energy,H as HighLoadScenario,V as LowLoadScenario,D as Memory,U as Network,$ as Playground,B as SystemMonitoring,E as WithAutoRefresh,W as WithProcessSelection,Oe as __namedExportsOrder,$e as default};
