import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as n}from"./iframe-CGazvlvx.js";import{c as ne}from"./utils-CDN07tui.js";import{T as se}from"./Table-C2Ks7Pr1.js";import{C as re}from"./Checkbox-DNKbkjdF.js";import{C as oe}from"./Combobox-C29Bml8R.js";import{D as le}from"./download-Ck7Je26J.js";import{c as K}from"./createLucideIcon-BMKVoASg.js";import{B as X}from"./Badge-g-1oBvWl.js";import"./preload-helper-PPVm8Dsz.js";import"./arrow-up-down-A9bswVle.js";import"./proxy-BNOm_ZMq.js";import"./resolve-elements-juiWZL7b.js";import"./chevron-left-CsA7Lttf.js";import"./chevron-right-C_gMmINW.js";import"./check-D3Ma7fjX.js";import"./minus-BAByJQZj.js";import"./chevrons-up-down-DmneY7FH.js";import"./index-C-eQ3fKV.js";import"./search-D6Ssf2h5.js";const ie=[["path",{d:"M12 17v5",key:"bb1du9"}],["path",{d:"M15 9.34V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H7.89",key:"znwnzq"}],["path",{d:"m2 2 20 20",key:"1ooewy"}],["path",{d:"M9 9v1.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h11",key:"c9qhm2"}]],ce=K("pin-off",ie);const de=[["path",{d:"M12 17v5",key:"bb1du9"}],["path",{d:"M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H8a2 2 0 0 0 0 4 1 1 0 0 1 1 1z",key:"1nkz8b"}]],me=K("pin",de);const ue=[["path",{d:"M14 17H5",key:"gfn3mx"}],["path",{d:"M19 7h-9",key:"6i9tg"}],["circle",{cx:"17",cy:"17",r:"3",key:"18b49y"}],["circle",{cx:"7",cy:"7",r:"3",key:"dfmy0x"}]],pe=K("settings-2",ue);function i({columns:a,data:t,selectable:m=!1,striped:l=!0,hoverable:c=!0,density:u="comfortable",page:p=1,pageSize:g=10,virtualScrolling:y=!1,maxHeight:b="600px",onPageChange:S,onSortChange:h,onCellEdit:B,onExport:$}){const[k,ye]=n.useState(null),[U,xe]=n.useState("asc"),[he,ve]=n.useState(new Set),[C,I]=n.useState(new Map(a.map(s=>[s.key,{visible:!0,pinned:null,width:s.width||150}]))),[O,be]=n.useState(new Map),[N,Q]=n.useState(null),[fe,Se]=n.useState(new Set),[Ce,je]=n.useState(null),[Ne,we]=n.useState(null),Y=s=>{I(x=>{const o=new Map(x),r=o.get(s);return r&&o.set(s,{...r,visible:!r.visible}),o})},Z=s=>{I(x=>{const o=new Map(x),r=o.get(s);if(r){const f=r.pinned==="left"?null:"left";o.set(s,{...r,pinned:f})}return o})},ee=()=>{if($)$();else{const s=a.filter(w=>C.get(w.key)?.visible),x=s.map(w=>w.header).join(","),o=j.map(w=>s.map(te=>{const D=w[te.key];return typeof D=="string"&&D.includes(",")?`"${D}"`:D}).join(",")).join(`
`),r=`${x}
