import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as x}from"./utils-DCADjnpI.js";const t=({children:a,columns:s=3,gap:c=16,className:p,style:h})=>{const m=Array.from({length:s},()=>[]);return a.forEach((i,l)=>{m[l%s].push(i)}),e.jsx("div",{className:x("w-full flex",p),style:{gap:c,...h},role:"list",children:m.map((i,l)=>e.jsx("div",{className:"flex-1 flex flex-col",style:{gap:c},role:"listitem",children:i},l))})};t.__docgenInfo={description:`MasonryLayout: Apple-minimal masonry grid
