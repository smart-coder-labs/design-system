import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-BGx_IYCs.js";import{t as r}from"./jsx-runtime-BscHEzdU.js";import{s as i,t as a}from"./es-Ch39IMKG.js";import{n as o,t as s}from"./utils-COD7dmCP.js";import{$n as c,Dt as l,J as u,Qt as d,Tn as f,W as p,br as m,ft as h,jt as g,nt as _,p as v,pr as y,s as b,st as x,t as S,v as C,z as w}from"./lucide-react-B3O-UhxF.js";var T,E,D,O,k,A=e((()=>{T=t(n()),a(),o(),E=r(),D=T.forwardRef(({leftContent:e,centerContent:t,rightContent:n,glass:r=!1,sticky:a=!0,showBorder:o=!0,size:c=`md`,className:l=``,...u},d)=>{let f=`
            ${{sm:`h-12 px-3`,md:`h-14 px-4`,lg:`h-16 px-6`}[c]}
            w-full
            flex items-center justify-between
            ${a?`sticky top-0 z-30`:``}
            ${r?`bg-surface-glass backdrop-blur-xl`:`bg-surface-primary`}
            ${o?`border-b border-border-primary`:``}
            transition-apple
        `;return(0,E.jsxs)(i.header,{ref:d,className:s(f,l),initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{type:`spring`,stiffness:300,damping:30},...u,children:[(0,E.jsx)(`div`,{className:`flex items-center gap-2 flex-1 min-w-0`,children:e}),t&&(0,E.jsx)(`div`,{className:`flex items-center justify-center gap-2 flex-shrink-0 px-4`,children:t}),(0,E.jsx)(`div`,{className:`flex items-center justify-end gap-2 flex-1 min-w-0`,children:n})]})}),D.displayName=`TopActionBar`,O=T.forwardRef(({children:e,icon:t,active:n=!1,variant:r=`default`,className:a=``,...o},c)=>{let l={default:`
        ...
        `;return(0,E.jsxs)(i.button,{ref:c,className:s(u,l[r],a),whileHover:{scale:1.02},whileTap:{scale:.98},...o,children:[t&&(0,E.jsx)(`span`,{className:`inline-flex`,children:t}),e]})}),O.displayName=`TopActionBarButton`,k=T.forwardRef(({icon:e,active:t=!1,badge:n,className:r=``,...a},o)=>{let c=`
            relative
