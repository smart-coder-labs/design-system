import{j as t}from"./jsx-runtime-u17CrQMm.js";import{O as c}from"./OTPInput-n2LPNqgb.js";import{r as p}from"./iframe-B3ue83QT.js";import"./utils-CDN07tui.js";import"./proxy-f4HTbMBa.js";import"./preload-helper-PPVm8Dsz.js";const S={title:"Forms/OTPInput",component:c,tags:[],argTypes:{length:{control:{type:"number",min:4,max:8}},groupSize:{control:{type:"number",min:0,max:8}},disabled:{control:"boolean"},error:{control:"boolean"}}},s={render:r=>{const[e,a]=p.useState("");return t.jsxs("div",{className:"flex flex-col items-center gap-4",children:[t.jsx(c,{...r,value:e,onChange:a,onComplete:g=>alert(`Completed: ${g}`)}),t.jsxs("p",{className:"text-sm text-text-tertiary",children:["Current value: ",e]})]})},args:{length:6,groupSize:3}},n={render:r=>{const[e,a]=p.useState("");return t.jsx(c,{...r,value:e,onChange:a})},args:{length:4,groupSize:2}},o={render:r=>{const[e,a]=p.useState("");return t.jsx(c,{...r,value:e,onChange:a})},args:{length:6,groupSize:0}},u={args:{length:6,error:!0,value:"123"}},l={args:{length:6,disabled:!0,value:"123456"}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: args => {
