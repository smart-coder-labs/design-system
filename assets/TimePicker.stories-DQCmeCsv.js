import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-CpZpVqtp.js";import{Un as r,t as i}from"./lucide-react-ClkQfjSy.js";import{n as a,t as o}from"./utils-ijcE-ZHT.js";import{t as s}from"./jsx-runtime-DaLCRA3n.js";import{l as c,s as l,t as u}from"./es-DgKUYGPE.js";var d,f,p,m,h,g,_=e((()=>{d=t(n()),u(),i(),a(),f=s(),p=e=>{if(!e)return null;let[t,n]=e.split(`:`).map(Number);return isNaN(t)||isNaN(n)||t<0||t>23||n<0||n>59?null:{hours:t,minutes:n}},m=(e,t,n)=>{let r=t.toString().padStart(2,`0`);if(n===`24h`)return`${e.toString().padStart(2,`0`)}:${r}`;{let t=e>=12?`PM`:`AM`;return`${e%12||12}:${r} ${t}`}},h=`
  w-full
  bg-surface-primary
