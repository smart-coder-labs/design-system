import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as i}from"./iframe-B9hmpDEG.js";import{c as m}from"./utils-CDN07tui.js";import{m as k}from"./proxy-Dckdfu8t.js";import{C as B}from"./clock-C85Z1Q3W.js";import{A as G}from"./index-D16B27Jy.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-Ct5Zk_dD.js";const J=a=>{if(!a)return null;const[s,n]=a.split(":").map(Number);return isNaN(s)||isNaN(n)||s<0||s>23||n<0||n>59?null:{hours:s,minutes:n}},E=(a,s,n)=>{const u=s.toString().padStart(2,"0");if(n==="24h")return`${a.toString().padStart(2,"0")}:${u}`;{const c=a>=12?"PM":"AM";return`${a%12||12}:${u} ${c}`}},K=`
  w-full
  bg-surface-primary
