import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-D0o8cdjS.js";import{En as r,Fn as i,Tn as a,jn as o,t as s,tr as c,v as l}from"./lucide-react-yAgQzC9Q.js";import{n as u,t as d}from"./utils-ijcE-ZHT.js";import{t as f}from"./jsx-runtime-DaLCRA3n.js";import{s as p,t as m}from"./es-biEEKJuQ.js";import{n as h,t as g}from"./Button-ChIMYuM7.js";var _,v,y,b=e((()=>{_=t(n()),u(),m(),s(),g(),v=f(),y=_.forwardRef(({codes:e,onCopy:t,onDownload:n,title:s=`Recovery Codes`,description:u=`Save these codes in a safe place. You can use them to access your account if you lose your device.`,showWarning:f=!0,className:m,...g},y)=>{let[b,x]=(0,_.useState)(null),[S,C]=(0,_.useState)(new Set),w=(e,n)=>{navigator.clipboard.writeText(e),x(n),setTimeout(()=>x(null),2e3),t?.(e)},T=e=>{C(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},E=()=>{let t=e.join(`
