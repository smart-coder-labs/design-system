import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as E,r as N}from"./iframe-B9hmpDEG.js";import{c as M}from"./utils-CDN07tui.js";import{B as n}from"./Button-yOzj7y9F.js";import{T as K}from"./triangle-alert-BCfcLrMp.js";import{m as Y}from"./proxy-Dckdfu8t.js";import{E as B}from"./eye-off-B3hcTbMu.js";import{E as P}from"./eye-BdZyxnEA.js";import{C as I}from"./check-83PbD5O-.js";import{C as j}from"./copy-rzAtjAjg.js";import{D as V}from"./download-DlByoX6U.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-Ct5Zk_dD.js";const y=E.forwardRef(({codes:a,onCopy:h,onDownload:f,title:R="Recovery Codes",description:x="Save these codes in a safe place. You can use them to access your account if you lose your device.",showWarning:D=!0,className:b,...S},T)=>{const[W,C]=N.useState(null),[v,L]=N.useState(new Set),w=(o,s)=>{navigator.clipboard.writeText(o),C(s),setTimeout(()=>C(null),2e3),h?.(o)},k=o=>{L(s=>{const t=new Set(s);return t.has(o)?t.delete(o):t.add(o),t})},A=()=>{const o=a.join(`
