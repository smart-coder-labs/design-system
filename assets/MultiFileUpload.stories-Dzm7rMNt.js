import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-BGx_IYCs.js";import{t as r}from"./jsx-runtime-BscHEzdU.js";import{l as i,s as a,t as o}from"./es-Ch39IMKG.js";import{n as s,t as c}from"./utils-COD7dmCP.js";import{Un as l,b as u,i as d,m as f,mn as p,t as m}from"./lucide-react-B3O-UhxF.js";var h,g,_,v,y=e((()=>{h=t(n()),o(),m(),s(),g=r(),_=(e,t=2)=>{if(e===0)return`0 Bytes`;let n=1024,r=t<0?0:t,i=[`Bytes`,`KB`,`MB`,`GB`,`TB`],a=Math.floor(Math.log(e)/Math.log(n));return parseFloat((e/n**+a).toFixed(r))+` `+i[a]},v=({label:e,value:t=[],onChange:n,accept:r,maxSize:o,maxFiles:s,disabled:m=!1,error:v,helperText:y,className:b})=>{let[x,S]=(0,h.useState)(t),[C,w]=(0,h.useState)(!1),[T,E]=(0,h.useState)(null),D=(0,h.useRef)(null),O=v||T;h.useEffect(()=>{t!==x&&S(t)},[t]);let k=e=>{e.preventDefault(),m||w(!0)},A=e=>{e.preventDefault(),w(!1)},j=e=>{if(o&&e.size>o)return`File "${e.name}" exceeds size limit of ${_(o)}`;if(r){let t=r.split(`,`).map(e=>e.trim()),n=e.type,i=e.name;if(!t.some(e=>e.endsWith(`/*`)?n.startsWith(e.replace(`/*`,``)):e.startsWith(`.`)?i.toLowerCase().endsWith(e.toLowerCase()):n===e))return`File "${e.name}" format not accepted`}return null},M=e=>{if(E(null),s&&x.length+e.length>s){E(`Maximum ${s} files allowed`);return}let t=[],r=null;if(e.forEach(e=>{let n=j(e);n?r=n:x.some(t=>t.name===e.name&&t.size===e.size)||t.push(e)}),r&&E(r),t.length>0){let e=[...x,...t];S(e),n?.(e)}},N=e=>{if(e.preventDefault(),w(!1),m)return;let t=Array.from(e.dataTransfer.files);t.length>0&&M(t)},P=e=>{let t=e.target.files?Array.from(e.target.files):[];t.length>0&&M(t),D.current&&(D.current.value=``)},F=e=>{let t=x.filter((t,n)=>n!==e);S(t),n?.(t),E(null)};return(0,g.jsxs)(`div`,{className:c(`w-full`,b),children:[(0,g.jsxs)(`div`,{className:`flex justify-between items-end mb-2`,children:[e&&(0,g.jsx)(`label`,{className:`block text-sm font-medium text-text-primary`,children:e}),x.length>0&&!m&&(0,g.jsxs)(`button`,{onClick:()=>{S([]),n?.([]),E(null)},className:`text-xs text-text-tertiary hover:text-status-error transition-colors flex items-center gap-1`,type:`button`,children:[(0,g.jsx)(u,{className:`w-3 h-3`}),`Clear all`]})]}),(0,g.jsxs)(`div`,{onClick:()=>{m||D.current?.click()},onDragOver:k,onDragLeave:A,onDrop:N,className:c(`relative group cursor-pointer rounded-xl border-2 border-dashed transition-all duration-200 ease-in-out overflow-hidden`,`min-h-[120px] flex flex-col items-center justify-center p-6 text-center`,C?`border-accent-blue bg-accent-blue/5 scale-[1.01]`:`border-border-secondary bg-surface-primary hover:bg-surface-secondary hover:border-border-primary`,O&&`border-status-error bg-status-error/5`,m&&`opacity-50 cursor-not-allowed hover:bg-surface-primary hover:border-border-secondary`),children:[(0,g.jsx)(`input`,{ref:D,type:`file`,className:`hidden`,multiple:!0,accept:r,onChange:P,disabled:m}),(0,g.jsxs)(`div`,{className:`flex flex-col items-center gap-2`,children:[(0,g.jsx)(`div`,{className:c(`p-3 rounded-full bg-surface-secondary transition-colors group-hover:bg-surface-tertiary`,C&&`bg-accent-blue/10 text-accent-blue`),children:(0,g.jsx)(f,{className:c(`w-6 h-6 text-text-secondary transition-colors`,C&&`text-accent-blue`)})}),(0,g.jsxs)(`div`,{className:`space-y-1`,children:[(0,g.jsxs)(`p`,{className:`text-sm font-medium text-text-primary`,children:[(0,g.jsx)(`span`,{className:`text-accent-blue hover:underline`,children:`Click to upload`}),` or drag and drop`]}),(0,g.jsxs)(`p`,{className:`text-xs text-text-tertiary`,children:[r?`Accepted formats: ${r.replace(/,/g,`, `)}`:`All files accepted`,o&&` • Max size: ${_(o)}`,s&&` • Max files: ${s}`]})]})]})]}),(O||y)&&(0,g.jsxs)(a.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},className:`mt-2 flex items-center gap-2`,children:[O&&(0,g.jsx)(l,{className:`w-4 h-4 text-status-error`}),(0,g.jsx)(`p`,{className:c(`text-sm`,O?`text-status-error`:`text-text-secondary`),children:O||y})]}),(0,g.jsx)(i,{children:x.length>0&&(0,g.jsx)(a.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:`auto`},exit:{opacity:0,height:0},className:`mt-4 space-y-2`,children:x.map((e,t)=>(0,g.jsxs)(a.div,{initial:{opacity:0,x:-10},animate:{opacity:1,x:0},exit:{opacity:0,x:10},className:`flex items-center gap-3 p-3 rounded-lg bg-surface-secondary border border-border-primary group/item`,children:[(0,g.jsx)(`div`,{className:`p-2 bg-surface-tertiary rounded-md`,children:(0,g.jsx)(p,{className:`w-5 h-5 text-accent-blue`})}),(0,g.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,g.jsx)(`p`,{className:`text-sm font-medium text-text-primary truncate`,children:e.name}),(0,g.jsx)(`p`,{className:`text-xs text-text-tertiary`,children:_(e.size)})]}),!m&&(0,g.jsx)(`button`,{onClick:()=>F(t),className:`p-1.5 rounded-md hover:bg-surface-tertiary text-text-tertiary hover:text-status-error transition-colors opacity-0 group-hover/item:opacity-100 focus:opacity-100`,type:`button`,"aria-label":`Remove file`,children:(0,g.jsx)(d,{className:`w-4 h-4`})})]},`${e.name}-${t}`))})})]})},v.displayName=`MultiFileUpload`,v.__docgenInfo={description:``,methods:[],displayName:`MultiFileUpload`,props:{label:{required:!1,tsType:{name:`string`},description:``},value:{required:!1,tsType:{name:`Array`,elements:[{name:`File`}],raw:`File[]`},description:``,defaultValue:{value:`[]`,computed:!1}},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(files: File[]) => void`,signature:{arguments:[{type:{name:`Array`,elements:[{name:`File`}],raw:`File[]`},name:`files`}],return:{name:`void`}}},description:``},accept:{required:!1,tsType:{name:`string`},description:``},maxSize:{required:!1,tsType:{name:`number`},description:``},maxFiles:{required:!1,tsType:{name:`number`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},error:{required:!1,tsType:{name:`string`},description:``},helperText:{required:!1,tsType:{name:`string`},description:``},className:{required:!1,tsType:{name:`string`},description:``}}}})),b,x,S,C,w,T,E,D,O,k,A,j;e((()=>{n(),y(),b=r(),{action:x}=__STORYBOOK_MODULE_ACTIONS__,S={title:`Forms/MultiFileUpload`,component:v,tags:[`autodocs`],parameters:{layout:`centered`}},C={args:{onUpload:x(`upload`),onRemove:x(`remove`)}},w={args:{files:[{id:`1`,name:`passport.pdf`,size:245e4,status:`uploaded`},{id:`2`,name:`selfie.jpg`,size:18e5,status:`uploaded`}],onUpload:x(`upload`),onRemove:x(`remove`)}},T={args:{files:[{id:`1`,name:`statement.pdf`,size:31e5,status:`uploading`,progress:65},{id:`2`,name:`id_card.png`,size:12e5,status:`uploaded`}],onUpload:x(`upload`),onRemove:x(`remove`)}},E={args:{files:[{id:`1`,name:`invalid_file.exe`,size:5e5,status:`error`,error:`File type not supported`},{id:`2`,name:`receipt.pdf`,size:42e4,status:`uploaded`}],onUpload:x(`upload`),onRemove:x(`remove`)}},D={render:()=>(0,b.jsxs)(`div`,{className:`w-full max-w-md space-y-4`,children:[(0,b.jsxs)(`div`,{children:[(0,b.jsx)(`h3`,{className:`text-sm font-bold text-text-primary`,children:`Identity Verification`}),(0,b.jsx)(`p`,{className:`text-xs text-text-tertiary mt-1`,children:`Upload your documents for verification`})]}),(0,b.jsx)(v,{files:[{id:`1`,name:`passport_us.pdf`,size:28e5,status:`uploaded`},{id:`2`,name:`selfie_photo.jpg`,size:15e5,status:`uploading`,progress:72}],accept:`image/*,application/pdf`,maxFiles:3,maxSize:5242880,onUpload:x(`upload`),onRemove:x(`remove`)})]})},O={args:{files:[{id:`1`,name:`receipt_amazon_apr15.png`,size:89e4,status:`uploaded`},{id:`2`,name:`receipt_starbucks.png`,size:45e4,status:`uploaded`},{id:`3`,name:`receipt_uber_apr14.png`,size:32e4,status:`uploaded`}],maxFiles:10,onUpload:x(`upload`),onRemove:x(`remove`)}},k={args:{files:[{id:`1`,name:`large_video.mp4`,size:15e7,status:`error`,error:`File exceeds 10MB limit`}],maxSize:10485760,onUpload:x(`upload`),onRemove:x(`remove`)}},A={args:{onUpload:x(`upload`),onRemove:x(`remove`),accept:`.pdf,.jpg,.png`,maxSize:10485760}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
