import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as E,r as N}from"./iframe-CSCYuKHF.js";import{c as M}from"./utils-DCADjnpI.js";import{B as n}from"./Button-Dvkzn2vT.js";import{T as K}from"./triangle-alert-BpJetIyV.js";import{m as Y}from"./proxy-DgdbOAE3.js";import{E as B}from"./eye-off-CIbTOIjP.js";import{E as P}from"./eye-B8wltVQw.js";import{C as I}from"./check-DA54vynO.js";import{C as j}from"./copy-BgGw0dbN.js";import{D as V}from"./download-CYIhROEN.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-BvoP2Q-9.js";import"./resolve-elements-BeIloL1I.js";const y=E.forwardRef(({codes:a,onCopy:h,onDownload:f,title:R="Recovery Codes",description:x="Save these codes in a safe place. You can use them to access your account if you lose your device.",showWarning:D=!0,className:b,...S},T)=>{const[W,C]=N.useState(null),[v,L]=N.useState(new Set),w=(o,s)=>{navigator.clipboard.writeText(o),C(s),setTimeout(()=>C(null),2e3),h?.(o)},k=o=>{L(s=>{const t=new Set(s);return t.has(o)?t.delete(o):t.add(o),t})},A=()=>{const o=a.join(`
