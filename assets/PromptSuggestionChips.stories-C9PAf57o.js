import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-Ns4lj-Vt.js";import{n as r,t as i}from"./utils-4pdYZGDS.js";import{t as a}from"./jsx-runtime-BK76Wfr-.js";import{s as o,t as s}from"./es-Bab7Eu6H.js";import{$t as c,F as l,Hn as u,Wt as d,bn as f,mr as p,t as m}from"./lucide-react-DM_OnbjU.js";var h,g,_,v=e((()=>{h=t(n()),r(),g=a(),s(),m(),_=h.forwardRef(({suggestions:e,onSuggestionClick:t,maxVisible:n=4,variant:r=`default`,className:a,...s},c)=>{let u=e.slice(0,n);return e.length===0?null:(0,g.jsx)(`div`,{ref:c,className:i(`flex flex-wrap gap-2`,r===`compact`&&`gap-1.5`,a),...s,children:u.map((e,n)=>(0,g.jsxs)(o.button,{onClick:()=>t?.(e),className:i(`inline-flex items-center gap-2 px-3 py-1.5 rounded-full`,`bg-surface-secondary border border-border-primary`,`text-sm font-medium text-text-primary`,`hover:bg-surface-tertiary hover:border-border-secondary`,`transition-colors focus:outline-none focus:ring-2 focus:ring-accent-blue`,r===`compact`&&`px-2.5 py-1 text-xs`),initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{delay:n*.05},whileHover:{scale:1.05},whileTap:{scale:.95},children:[e.icon||(0,g.jsx)(l,{className:`w-3.5 h-3.5 text-accent-blue`}),(0,g.jsx)(`span`,{children:e.text})]},e.id))})}),_.displayName=`PromptSuggestionChips`,_.__docgenInfo={description:``,methods:[],displayName:`PromptSuggestionChips`,props:{suggestions:{required:!0,tsType:{name:`Array`,elements:[{name:`PromptSuggestion`}],raw:`PromptSuggestion[]`},description:``},onSuggestionClick:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(suggestion: PromptSuggestion) => void`,signature:{arguments:[{type:{name:`PromptSuggestion`},name:`suggestion`}],return:{name:`void`}}},description:``},maxVisible:{required:!1,tsType:{name:`number`},description:``,defaultValue:{value:`4`,computed:!1}},variant:{required:!1,tsType:{name:`union`,raw:`'default' | 'compact'`,elements:[{name:`literal`,value:`'default'`},{name:`literal`,value:`'compact'`}]},description:``,defaultValue:{value:`'default'`,computed:!1}},className:{required:!1,tsType:{name:`string`},description:``}}}})),y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{v(),m(),y=a(),b={title:`Forms/PromptSuggestionChips`,component:_,parameters:{layout:`centered`},tags:[`autodocs`]},x=[{id:`1`,text:`Explain quantum computing`,icon:(0,y.jsx)(l,{className:`w-3.5 h-3.5`})},{id:`2`,text:`Write a Python function`,icon:(0,y.jsx)(u,{className:`w-3.5 h-3.5`})},{id:`3`,text:`Generate an image`,icon:(0,y.jsx)(c,{className:`w-3.5 h-3.5`})},{id:`4`,text:`Summarize this document`,icon:(0,y.jsx)(f,{className:`w-3.5 h-3.5`})}],S={args:{suggestions:x,onSuggestionClick:e=>console.log(`Clicked:`,e)}},C={args:{suggestions:x,variant:`compact`,onSuggestionClick:e=>console.log(`Clicked:`,e)}},w={args:{suggestions:[{id:`1`,text:`Get creative ideas`,icon:(0,y.jsx)(d,{className:`w-3.5 h-3.5 text-yellow-500`})},{id:`2`,text:`Write code`,icon:(0,y.jsx)(u,{className:`w-3.5 h-3.5 text-green-500`})},{id:`3`,text:`Create image`,icon:(0,y.jsx)(c,{className:`w-3.5 h-3.5 text-purple-500`})},{id:`4`,text:`Calculate`,icon:(0,y.jsx)(p,{className:`w-3.5 h-3.5 text-blue-500`})}],onSuggestionClick:e=>console.log(`Clicked:`,e)}},T={args:{suggestions:[...x,{id:`5`,text:`Translate text`},{id:`6`,text:`Analyze data`}],maxVisible:3,onSuggestionClick:e=>console.log(`Clicked:`,e)}},E={args:{suggestions:[{id:`1`,text:`Explain quantum computing`},{id:`2`,text:`Write a Python function`},{id:`3`,text:`Generate an image`},{id:`4`,text:`Summarize this document`},{id:`5`,text:`Translate to Spanish`},{id:`6`,text:`Analyze this data`},{id:`7`,text:`Create a presentation`},{id:`8`,text:`Debug my code`}],onSuggestionClick:e=>console.log(`Clicked:`,e)}},D={args:{suggestions:[{id:`1`,text:`Help`},{id:`2`,text:`Code`},{id:`3`,text:`Write`},{id:`4`,text:`Analyze`}],variant:`compact`,onSuggestionClick:e=>console.log(`Clicked:`,e)}},O={args:{suggestions:[{id:`1`,text:`Help me understand the fundamental principles of machine learning`},{id:`2`,text:`Write a comprehensive guide to React hooks and their use cases`},{id:`3`,text:`Generate a detailed business plan for a tech startup`}],onSuggestionClick:e=>console.log(`Clicked:`,e)}},k={args:{suggestions:[],onSuggestionClick:e=>console.log(`Clicked:`,e)}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
