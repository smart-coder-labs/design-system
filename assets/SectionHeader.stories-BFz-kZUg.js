import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DuoaHqPM.js";import{t as r}from"./jsx-runtime-BscHEzdU.js";import{n as i,t as a}from"./utils-COD7dmCP.js";var o,s,c,l=e((()=>{o=t(n()),i(),s=r(),c=o.forwardRef(({className:e,title:t,description:n,actions:r,size:i=`md`,divider:o=!1,...c},l)=>{let u={sm:`text-lg`,md:`text-2xl`,lg:`text-3xl`},d={sm:`text-sm`,md:`text-base`,lg:`text-lg`};return(0,s.jsx)(`div`,{ref:l,className:a(`flex flex-col gap-4 w-full`,o&&`border-b border-border-primary pb-4 mb-4`,e),...c,children:(0,s.jsxs)(`div`,{className:`flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4`,children:[(0,s.jsxs)(`div`,{className:`space-y-1 flex-1`,children:[(0,s.jsx)(`h2`,{className:a(`font-bold text-text-primary tracking-tight`,u[i]),children:t}),n&&(0,s.jsx)(`p`,{className:a(`text-text-secondary leading-relaxed`,d[i]),children:n})]}),r&&(0,s.jsx)(`div`,{className:`flex items-center gap-2 flex-shrink-0 mt-1 sm:mt-0`,children:r})]})})}),c.displayName=`SectionHeader`,c.__docgenInfo={description:``,methods:[],displayName:`SectionHeader`,props:{title:{required:!0,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:`The main title of the section.`},description:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:`Optional description or subtitle.`},actions:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:`Optional actions to display on the right side (e.g., Buttons).`},size:{required:!1,tsType:{name:`union`,raw:`'sm' | 'md' | 'lg'`,elements:[{name:`literal`,value:`'sm'`},{name:`literal`,value:`'md'`},{name:`literal`,value:`'lg'`}]},description:`Size of the header, affecting typography.
