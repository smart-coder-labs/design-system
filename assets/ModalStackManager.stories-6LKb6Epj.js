import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DL3IwwZJ.js";import{t as r}from"./jsx-runtime-BK76Wfr-.js";import{n as i,t as a}from"./Button-l9_4D6Ta.js";import{a as o,c as s,i as c,l,n as u,o as d,r as f,s as p,t as m}from"./Modal-A1zerocv.js";var h,g,_,v=e((()=>{h=t(n()),l(),i(),g=r(),_=e=>{let{initialStack:t=[],className:n,open:r,onCloseAll:i}=e,[l,_]=(0,h.useState)(t),[v,y]=(0,h.useState)(t.length>0),b=r===void 0?v:r;h.useEffect(()=>{b&&l.length===0&&t.length>0&&_(t)},[b,t,l.length]);let x=e=>{_(t=>[...t,e]),y(!0)},S=()=>{_(e=>e.slice(0,-1)),y(l.length>1),l.length<=1&&i&&i()},C=()=>{_([]),y(!1),i&&i()};return(0,g.jsx)(g.Fragment,{children:l.map((e,t)=>(0,g.jsxs)(m,{open:b&&t===l.length-1,onOpenChange:e=>{e||S()},size:e.size||`md`,children:[(0,g.jsx)(f,{}),(0,g.jsxs)(p,{children:[(0,g.jsx)(s,{children:e.title}),e.description&&(0,g.jsx)(o,{children:e.description})]}),(0,g.jsx)(c,{children:e.content}),(0,g.jsxs)(d,{children:[(0,g.jsx)(u,{children:(0,g.jsx)(a,{variant:`ghost`,children:`Cerrar`})}),t===l.length-1&&(0,g.jsx)(a,{variant:`primary`,onClick:()=>x({title:`Modal Secundario`,description:`Este modal se apila sobre el anterior.`,content:(0,g.jsx)(`p`,{children:`Contenido del modal secundario.`}),footer:(0,g.jsx)(a,{variant:`ghost`,onClick:C,children:`Cerrar todo`}),size:`sm`}),children:`Abrir otro modal`}),e.footer]})]},t))})},_.__docgenInfo={description:`ModalStackManager: gestiona múltiples modales apilados estilo macOS/iOS
