import{n as e}from"./chunk-jRWAZmH_.js";import{a as t}from"./iframe-DuoaHqPM.js";import{t as n}from"./jsx-runtime-BscHEzdU.js";import{l as r,s as i,t as a}from"./es-lKEstbry.js";import{n as o,t as s}from"./utils-COD7dmCP.js";import{n as c,t as l}from"./Spinner-BMsIujeJ.js";var u,d,f=e((()=>{t(),a(),l(),o(),u=n(),d=({isLoading:e,message:t,fullPage:n=!1,blur:a=!0,className:o,spinnerSize:l=`lg`})=>(0,u.jsx)(r,{children:e&&(0,u.jsx)(i.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},className:s(`flex flex-col items-center justify-center z-50`,n?`fixed inset-0`:`absolute inset-0 rounded-inherit`,a?`backdrop-blur-sm`:``,`bg-surface-primary/80`,o),children:(0,u.jsxs)(`div`,{className:s(`flex flex-col items-center gap-4`,a?`p-4`:`p-6 bg-surface-elevated rounded-xl shadow-lg border border-border-primary`),children:[(0,u.jsx)(c,{size:l}),t&&(0,u.jsx)(i.p,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},className:`text-sm font-medium text-text-secondary`,children:t})]})})}),d.displayName=`LoadingOverlay`,d.__docgenInfo={description:``,methods:[],displayName:`LoadingOverlay`,props:{isLoading:{required:!0,tsType:{name:`boolean`},description:`Whether the loading overlay is visible`},message:{required:!1,tsType:{name:`string`},description:`Optional message to display below the spinner`},fullPage:{required:!1,tsType:{name:`boolean`},description:`Whether to cover the entire viewport (fixed) or just the parent container (absolute)
