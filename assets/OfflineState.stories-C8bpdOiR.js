import{n as e}from"./chunk-jRWAZmH_.js";import{a as t}from"./iframe-Ns4lj-Vt.js";import{t as n}from"./jsx-runtime-BK76Wfr-.js";import{s as r,t as i}from"./es-Bab7Eu6H.js";import{at as a,o,t as s}from"./lucide-react-DM_OnbjU.js";import{n as c,t as l}from"./Button-D5QeBcms.js";var u,d,f=e((()=>{t(),i(),s(),c(),u=n(),d=({title:e=`No Internet Connection`,description:t=`Please check your network settings and try again.`,onRetry:n,isRetrying:i=!1,fullPage:s=!1,className:c=``,icon:d})=>(0,u.jsx)(`div`,{className:`
    flex flex-col items-center justify-center text-center p-8
    ${s?`fixed inset-0 z-50 bg-background-primary/95 backdrop-blur-sm`:`w-full h-full bg-surface-primary rounded-2xl`}
    ${c}
  `.trim().replace(/\s+/g,` `),children:(0,u.jsxs)(r.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.4,ease:[.16,1,.3,1]},className:`max-w-md mx-auto flex flex-col items-center`,children:[(0,u.jsxs)(`div`,{className:`mb-6 relative`,children:[(0,u.jsx)(r.div,{className:`absolute inset-0 bg-status-error/10 rounded-full blur-xl`,animate:{opacity:[.3,.6,.3],scale:[1,1.1,1]},transition:{duration:3,repeat:1/0,ease:`easeInOut`}}),(0,u.jsx)(`div`,{className:`relative bg-surface-secondary p-5 rounded-full`,children:d||(0,u.jsx)(o,{className:`w-10 h-10 text-text-secondary`,strokeWidth:1.5})})]}),(0,u.jsx)(`h3`,{className:`text-xl font-semibold text-text-primary mb-2`,children:e}),(0,u.jsx)(`p`,{className:`text-text-secondary mb-8 leading-relaxed`,children:t}),n&&(0,u.jsx)(l,{variant:`primary`,onClick:n,loading:i,leftIcon:i?void 0:(0,u.jsx)(a,{size:16}),children:`Try Again`})]})}),d.displayName=`OfflineState`,d.__docgenInfo={description:``,methods:[],displayName:`OfflineState`,props:{title:{required:!1,tsType:{name:`string`},description:`Title of the offline state
