import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-B_S8iqXg.js";import{At as r,Er as i,K as a,Pt as o,V as s,Z as c,ar as l,at as u,ht as d,jn as f,nn as p,p as m,s as h,t as g,ut as _,y as v,yr as y}from"./lucide-react-D-LjNNxx.js";import{n as b,t as x}from"./utils-ijcE-ZHT.js";import{t as S}from"./jsx-runtime-DaLCRA3n.js";import{s as C,t as w}from"./es-BRhHMXe0.js";var T,E,D,O,k,A=e((()=>{T=t(n()),w(),b(),E=S(),D=T.forwardRef(({leftContent:e,centerContent:t,rightContent:n,glass:r=!1,sticky:i=!0,showBorder:a=!0,size:o=`md`,className:s=``,...c},l)=>{let u=`
            ${{sm:`h-12 px-3`,md:`h-14 px-4`,lg:`h-16 px-6`}[o]}
            w-full
            flex items-center justify-between
            ${i?`sticky top-0 z-30`:``}
            ${r?`bg-surface-glass backdrop-blur-xl`:`bg-surface-primary`}
            ${a?`border-b border-border-primary`:``}
            transition-apple
        `;return(0,E.jsxs)(C.header,{ref:l,className:x(u,s),initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{type:`spring`,stiffness:300,damping:30},...c,children:[(0,E.jsx)(`div`,{className:`flex items-center gap-2 flex-1 min-w-0`,children:e}),t&&(0,E.jsx)(`div`,{className:`flex items-center justify-center gap-2 flex-shrink-0 px-4`,children:t}),(0,E.jsx)(`div`,{className:`flex items-center justify-end gap-2 flex-1 min-w-0`,children:n})]})}),D.displayName=`TopActionBar`,O=T.forwardRef(({children:e,icon:t,active:n=!1,variant:r=`default`,className:i=``,...a},o)=>{let s={default:`
        ...
        `;return(0,E.jsxs)(C.button,{ref:o,className:x(c,s[r],i),whileHover:{scale:1.02},whileTap:{scale:.98},...a,children:[t&&(0,E.jsx)(`span`,{className:`inline-flex`,children:t}),e]})}),O.displayName=`TopActionBarButton`,k=T.forwardRef(({icon:e,active:t=!1,badge:n,className:r=``,...i},a)=>{let o=`
            relative
