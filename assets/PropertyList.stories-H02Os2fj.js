import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-BUF2whoS.js";import{n as r,t as i}from"./utils-4pdYZGDS.js";import{t as a}from"./jsx-runtime-BK76Wfr-.js";import{l as o,s,t as c}from"./es-8Z2IY91W.js";import{er as l,t as u}from"./lucide-react-D5svGO2N.js";var d,f,p,m,h=e((()=>{d=t(n()),c(),r(),f=a(),u(),p=(0,d.forwardRef)(({sections:e,variant:t=`default`,size:n=`md`,collapsible:r=!0,dividers:a=!0,className:c,...u},p)=>{let[m,h]=(0,d.useState)(new Set(e.filter(e=>e.defaultExpanded!==!1).map(e=>e.id))),[g,_]=(0,d.useState)(null),[v,y]=(0,d.useState)(``),b=e=>{r&&h(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},x=(e,t,n)=>{_(`${e}-${t}`),y(String(n.value))},S=e=>{e.onChange&&e.onChange(v),_(null)},C=()=>{_(null)},w={sm:{label:`text-xs`,value:`text-sm`,padding:`px-3 py-2`,headerPadding:`px-3 py-2`},md:{label:`text-xs`,value:`text-sm`,padding:`px-4 py-3`,headerPadding:`px-4 py-3`},lg:{label:`text-sm`,value:`text-base`,padding:`px-5 py-4`,headerPadding:`px-5 py-4`}};return(0,f.jsx)(`div`,{ref:p,className:i(`overflow-hidden`,{default:`bg-surface-primary`,bordered:`bg-surface-primary border border-border-primary rounded-xl shadow-sm overflow-hidden`,inset:`bg-surface-secondary rounded-lg`}[t],c),...u,children:e.map((e,c)=>{let u=m.has(e.id),d=e.title&&(r||e.title);return(0,f.jsxs)(`div`,{className:i(c!==0&&t!==`bordered`&&`border-t border-border-primary`),children:[d&&(0,f.jsxs)(`button`,{onClick:()=>b(e.id),disabled:!r,className:i(`w-full flex items-center justify-between text-left bg-surface-secondary/50 border-b border-border-primary`,w[n].headerPadding,r&&`hover:bg-surface-secondary transition-colors cursor-pointer`,!r&&`cursor-default`),children:[(0,f.jsx)(`span`,{className:`text-[11px] font-bold text-text-secondary uppercase tracking-wider`,children:e.title}),r&&(0,f.jsx)(s.div,{animate:{rotate:u?90:0},transition:{duration:.15},children:(0,f.jsx)(l,{className:`w-3.5 h-3.5 text-text-tertiary`})})]}),(0,f.jsx)(o,{initial:!1,children:(u||!r)&&(0,f.jsx)(s.div,{initial:r?{height:0,opacity:0}:!1,animate:{height:`auto`,opacity:1},exit:r?{height:0,opacity:0}:{},transition:{duration:.2,ease:[.16,1,.3,1]},className:`overflow-hidden`,children:e.items.map((t,r)=>{let o=`${e.id}-${r}`,s=g===o;return(0,f.jsxs)(`div`,{className:i(`flex items-center justify-between group`,w[n].padding,a&&r!==e.items.length-1&&`border-b border-border-secondary`,t.editable&&!s&&`hover:bg-surface-secondary/30 cursor-pointer`,`transition-colors`),onClick:()=>{t.editable&&!s&&x(e.id,r,t)},children:[(0,f.jsxs)(`div`,{className:`flex items-center gap-2 flex-shrink-0 min-w-[120px] max-w-[160px]`,children:[t.icon&&(0,f.jsx)(`span`,{className:`text-text-tertiary flex-shrink-0`,children:t.icon}),(0,f.jsx)(`span`,{className:i(`font-medium text-text-secondary truncate`,w[n].label),children:t.label})]}),(0,f.jsx)(`div`,{className:`flex-1 text-right min-w-0 pl-4`,children:s?(0,f.jsxs)(`div`,{className:`flex items-center gap-2 justify-end`,onClick:e=>e.stopPropagation(),children:[(0,f.jsx)(`input`,{type:`text`,value:v,onChange:e=>y(e.target.value),onKeyDown:e=>{e.key===`Enter`&&S(t),e.key===`Escape`&&C()},className:i(`flex-1 bg-surface-primary border border-accent-blue rounded-md px-2 py-1 text-right focus:outline-none focus:ring-2 focus:ring-accent-blue/30`,w[n].value),autoFocus:!0}),(0,f.jsx)(`button`,{onClick:()=>S(t),className:`text-accent-blue hover:text-accent-blue-hover text-xs font-semibold`,children:`OK`}),(0,f.jsx)(`button`,{onClick:C,className:`text-text-tertiary hover:text-text-secondary text-xs`,children:`Cancel`})]}):(0,f.jsx)(`span`,{className:i(`text-text-primary break-words leading-relaxed`,w[n].value,t.editable&&`group-hover:text-accent-blue transition-colors`),children:t.value})})]},o)})})})]},e.id)})})}),p.displayName=`PropertyList`,m=(0,d.forwardRef)((e,t)=>(0,f.jsx)(p,{ref:t,...e,size:`sm`})),m.displayName=`CompactPropertyList`,p.__docgenInfo={description:``,methods:[],displayName:`PropertyList`,props:{sections:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
    id: string;
    title?: string;
    items: PropertyItem[];
