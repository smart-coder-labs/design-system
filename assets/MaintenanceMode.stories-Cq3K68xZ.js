import{n as e}from"./chunk-jRWAZmH_.js";import{a as t}from"./iframe-DuoaHqPM.js";import{t as n}from"./jsx-runtime-BscHEzdU.js";import{s as r,t as i}from"./es-lKEstbry.js";import{An as a,Ln as o,t as s,yr as c}from"./lucide-react-Js4yG5Ra.js";import{n as l,t as u}from"./Button-Cafbi4DX.js";var d,f,p=e((()=>{t(),i(),s(),u(),d=n(),f=({title:e=`We'll be back soon`,description:t=`We're currently performing some scheduled maintenance. We should be back shortly.`,estimatedReturnTime:n,showContactSupport:i=!0,customAction:s,fullPage:u=!0,className:f=``,onContactSupport:p})=>(0,d.jsx)(`div`,{className:`
    flex flex-col items-center justify-center text-center p-8
    ${u?`min-h-screen w-full bg-background-secondary`:`w-full h-full bg-surface-primary rounded-2xl`}
    ${f}
  `.trim().replace(/\s+/g,` `),children:(0,d.jsxs)(r.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,ease:[.16,1,.3,1]},className:`max-w-md mx-auto`,children:[(0,d.jsxs)(`div`,{className:`relative mb-8 inline-flex items-center justify-center`,children:[(0,d.jsx)(r.div,{className:`absolute inset-0 bg-accent-blue/10 rounded-full blur-xl`,animate:{scale:[1,1.2,1],opacity:[.5,.8,.5]},transition:{duration:4,repeat:1/0,ease:`easeInOut`}}),(0,d.jsx)(`div`,{className:`relative bg-surface-primary p-6 rounded-full shadow-lg border border-border-primary`,children:(0,d.jsx)(a,{className:`w-12 h-12 text-accent-blue`,strokeWidth:1.5})})]}),(0,d.jsx)(`h1`,{className:`text-3xl font-bold text-text-primary mb-4 tracking-tight`,children:e}),(0,d.jsx)(`p`,{className:`text-text-secondary text-lg mb-8 leading-relaxed`,children:t}),n&&(0,d.jsxs)(`div`,{className:`flex items-center justify-center gap-2 text-text-tertiary mb-8 bg-surface-tertiary/50 py-2 px-4 rounded-full inline-flex`,children:[(0,d.jsx)(o,{size:16}),(0,d.jsxs)(`span`,{className:`text-sm font-medium`,children:[`Expected return: `,n]})]}),(0,d.jsxs)(`div`,{className:`flex flex-col sm:flex-row items-center justify-center gap-4`,children:[s,i&&!s&&(0,d.jsx)(l,{variant:`outline`,onClick:p,rightIcon:(0,d.jsx)(c,{size:16}),children:`Contact Support`})]}),(0,d.jsx)(`div`,{className:`mt-12 text-sm text-text-quaternary`,children:(0,d.jsxs)(`p`,{children:[`System Status: `,(0,d.jsx)(`span`,{className:`text-status-warning font-medium`,children:`Maintenance`})]})})]})}),f.displayName=`MaintenanceMode`,f.__docgenInfo={description:``,methods:[],displayName:`MaintenanceMode`,props:{title:{required:!1,tsType:{name:`string`},description:`Title of the maintenance page
