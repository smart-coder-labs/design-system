import{j as e}from"./jsx-runtime-u17CrQMm.js";import{A as a,a as t}from"./ActivityFeed-RFWy31fd.js";import{B as o}from"./Button-BlzVxrzH.js";import{B as m}from"./Badge-DHzmSvnH.js";import{T as l}from"./thumbs-up-BIZpZWnB.js";import{M as p}from"./message-square-xYeiUmx3.js";import{C as u}from"./calendar-DR1yNi5W.js";import{S as x}from"./shield-alert-DTo5hfzj.js";import{L as g}from"./lock-CbNx2urB.js";import"./iframe-ChONrTG_.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CDN07tui.js";import"./Avatar-Db02M5fw.js";import"./index-B_jtOnfb.js";import"./file-text-tvLcY6VY.js";import"./createLucideIcon-CdJ-Xkq_.js";import"./circle-check-RzGsjOQJ.js";import"./circle-alert-B5udOMzy.js";import"./git-commit-horizontal-DVbxSYVE.js";import"./proxy-CRCEyvcV.js";import"./resolve-elements-juiWZL7b.js";const U={title:"Data Display/ActivityFeed",component:a,parameters:{layout:"padded"},tags:[]},s={render:()=>e.jsx("div",{className:"max-w-2xl mx-auto",children:e.jsxs(a,{children:[e.jsx(t,{actor:{name:"Sarah Chen",initials:"SC"},action:"commented on",target:"Issue #429",date:"2h ago",type:"comment",children:e.jsx("p",{children:"I've updated the documentation to reflect the new API changes. Can someone review it?"})}),e.jsx(t,{actor:{name:"Mike Ross",initials:"MR"},action:"pushed 3 commits to",target:"feature/auth-v2",date:"4h ago",type:"commit",children:e.jsxs("div",{className:"space-y-1 font-mono text-xs",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-accent-blue",children:"a1b2c3d"}),e.jsx("span",{children:"feat: implement JWT rotation"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-accent-blue",children:"d4e5f6g"}),e.jsx("span",{children:"fix: session timeout handling"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-accent-blue",children:"h7i8j9k"}),e.jsx("span",{children:"chore: update dependencies"})]})]})}),e.jsx(t,{actor:{name:"Alex Morgan",initials:"AM"},action:"merged pull request",target:"#842: Timeline Component",date:"Yesterday",type:"pr"}),e.jsx(t,{actor:{name:"System",initials:"SY"},action:"deployed to",target:"Production",date:"Yesterday",type:"success",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(m,{variant:"success",size:"sm",children:"Success"}),e.jsx("span",{className:"text-xs text-text-secondary",children:"Deployment #1024 completed in 45s"})]})})]})})},i={render:()=>e.jsx("div",{className:"max-w-2xl mx-auto",children:e.jsxs(a,{children:[e.jsxs(t,{actor:{name:"David Kim",initials:"DK"},action:"requested changes on",target:"PR #850",date:"10m ago",type:"alert",children:[e.jsx("p",{className:"mb-2",children:"We need to handle the edge case where the user has no permissions."}),e.jsxs("div",{className:"bg-surface-primary p-3 rounded border border-border-primary font-mono text-xs overflow-x-auto",children:[e.jsx("span",{className:"text-status-error",children:"- if (user.role === 'admin')"}),e.jsx("br",{}),e.jsx("span",{className:"text-status-success",children:"+ if (hasPermission(user, 'manage_users'))"})]})]}),e.jsxs(t,{actor:{name:"Emily White",initials:"EW"},action:"replied",date:"5m ago",type:"comment",children:[e.jsx("p",{children:"Good catch! I'll update it right away."}),e.jsxs("div",{className:"mt-3 flex gap-2",children:[e.jsx(o,{size:"sm",variant:"ghost",leftIcon:e.jsx(l,{className:"w-3 h-3"}),children:"Like"}),e.jsx(o,{size:"sm",variant:"ghost",leftIcon:e.jsx(p,{className:"w-3 h-3"}),children:"Reply"})]})]})]})})},r={args:{items:[{actor:{name:"Bot",initials:"B"},action:"created ticket",target:"OPS-123",date:"Just now",type:"default"},{actor:{name:"Alice",initials:"A"},action:"assigned to",target:"Bob",date:"1m ago",type:"default"},{actor:{name:"Bob",initials:"B"},action:"changed status to",target:"In Progress",date:"30s ago",type:"success"}]},render:d=>e.jsx("div",{className:"max-w-xl mx-auto",children:e.jsx(a,{...d})})},n={name:"🛡️ Use Case: Security Audit Log",render:()=>e.jsx("div",{className:"max-w-2xl mx-auto",children:e.jsxs(a,{children:[e.jsx(t,{actor:{name:"Admin User",initials:"AU"},action:"changed organization settings",date:"2 hours ago",type:"alert",icon:x,children:e.jsx("p",{children:'Enforced 2FA for all members of the "Engineering" group.'})}),e.jsx(t,{actor:{name:"System",initials:"SYS"},action:"blocked suspicious login attempt",target:"IP 192.168.1.1",date:"4 hours ago",type:"alert"}),e.jsx(t,{actor:{name:"Sarah Connor",initials:"SC"},action:"updated password",date:"Yesterday",type:"default",icon:g})]})})},c={name:"📊 Use Case: Project Management",render:()=>e.jsx("div",{className:"max-w-2xl mx-auto",children:e.jsxs(a,{children:[e.jsx(t,{actor:{name:"Product Manager",initials:"PM"},action:"moved ticket",target:"PROJ-123",date:"10m ago",type:"default",children:e.jsxs("div",{className:"flex items-center gap-2 text-xs",children:[e.jsx("span",{className:"bg-surface-secondary px-2 py-1 rounded",children:"In Progress"}),e.jsx("span",{children:"→"}),e.jsx("span",{className:"bg-accent-blue/10 text-accent-blue px-2 py-1 rounded font-medium",children:"QA Review"})]})}),e.jsx(t,{actor:{name:"Lead Dev",initials:"LD"},action:"attached file",target:"architecture_diagram.pdf",date:"1h ago",type:"file"}),e.jsx(t,{actor:{name:"QA Engineer",initials:"QA"},action:"added due date",target:"Nov 24, 2025",date:"2h ago",type:"default",icon:u})]})})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source}}};const Y=["Default","CodeReview","DataDriven","SecurityAuditLog","ProjectUpdates"];export{i as CodeReview,r as DataDriven,s as Default,c as ProjectUpdates,n as SecurityAuditLog,Y as __namedExportsOrder,U as default};
