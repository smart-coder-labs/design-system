import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as E,r as N}from"./iframe-FxOJXbvx.js";import{c as M}from"./utils-CDN07tui.js";import{B as n}from"./Button-C6s9DX-s.js";import{T as K}from"./triangle-alert-DtyNdUYC.js";import{m as Y}from"./proxy-PznluMrK.js";import{E as B}from"./eye-off-oA9s9E3j.js";import{E as P}from"./eye-BqqMHpnd.js";import{C as I}from"./check-XCcrJdEL.js";import{C as j}from"./copy-BQ0-qtDZ.js";import{D as V}from"./download-BlPFDcw4.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DJ7P2U_s.js";const y=E.forwardRef(({codes:a,onCopy:h,onDownload:f,title:R="Recovery Codes",description:x="Save these codes in a safe place. You can use them to access your account if you lose your device.",showWarning:D=!0,className:b,...S},T)=>{const[W,C]=N.useState(null),[v,L]=N.useState(new Set),w=(o,s)=>{navigator.clipboard.writeText(o),C(s),setTimeout(()=>C(null),2e3),h?.(o)},k=o=>{L(s=>{const t=new Set(s);return t.has(o)?t.delete(o):t.add(o),t})},A=()=>{const o=a.join(`
