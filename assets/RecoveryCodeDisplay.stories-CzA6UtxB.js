import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as E,r as N}from"./iframe-D5DOIGW8.js";import{c as M}from"./utils-CDN07tui.js";import{B as n}from"./Button-yixddUw3.js";import{T as K}from"./triangle-alert-DbMYMbdc.js";import{m as Y}from"./proxy-BbTJ7w1C.js";import{E as B}from"./eye-off-DHPwtyBv.js";import{E as P}from"./eye-B0v26I4f.js";import{C as I}from"./check-cKab_vAK.js";import{C as j}from"./copy-CjH-Ztks.js";import{D as V}from"./download-3Gaqn17z.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-DOQ0Nu6C.js";const y=E.forwardRef(({codes:a,onCopy:h,onDownload:f,title:R="Recovery Codes",description:x="Save these codes in a safe place. You can use them to access your account if you lose your device.",showWarning:D=!0,className:b,...S},T)=>{const[W,C]=N.useState(null),[v,L]=N.useState(new Set),w=(o,s)=>{navigator.clipboard.writeText(o),C(s),setTimeout(()=>C(null),2e3),h?.(o)},k=o=>{L(s=>{const t=new Set(s);return t.has(o)?t.delete(o):t.add(o),t})},A=()=>{const o=a.join(`
