import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-Ns4lj-Vt.js";import{n as r,t as i}from"./utils-4pdYZGDS.js";import{t as a}from"./jsx-runtime-BK76Wfr-.js";import{l as o,s,t as c}from"./es-Bab7Eu6H.js";import{Zn as l,kr as u,nr as d,p as f,s as p,t as m}from"./lucide-react-DM_OnbjU.js";var h,g,_,v,y=e((()=>{h=t(n()),c(),r(),m(),g=a(),_=[{code:`USD`,symbol:`$`,name:`US Dollar`,flag:`🇺🇸`},{code:`MXN`,symbol:`$`,name:`Mexican Peso`,flag:`🇲🇽`},{code:`EUR`,symbol:`€`,name:`Euro`,flag:`🇪🇺`}],v=({recipients:e=[],currencies:t=_,availableBalance:n=0,defaultCurrency:r=`USD`,onSubmit:a,className:c=``})=>{let[m,v]=(0,h.useState)(``),[y,b]=(0,h.useState)(r),[x,S]=(0,h.useState)(``),[C,w]=(0,h.useState)(``),[T,E]=(0,h.useState)(!1),[D,O]=(0,h.useState)(!1),k=parseFloat(m)||0,A=k>n,j=k>0&&x&&!A,M=t.find(e=>e.code===y)||t[0],N=e.find(e=>e.id===x);return(0,g.jsxs)(s.form,{className:i(`bg-surface-primary rounded-2xl border border-border-primary shadow-sm p-6`,c),onSubmit:e=>{e.preventDefault(),j&&a?.({recipientId:x,amount:k,currency:y,concept:C})},initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.3,ease:[.16,1,.3,1]},children:[(0,g.jsx)(`h3`,{className:`text-base font-bold text-text-primary mb-5`,children:`Send Money`}),(0,g.jsxs)(`div`,{className:`mb-5`,children:[(0,g.jsx)(`label`,{className:`text-xs font-medium text-text-secondary mb-1.5 block`,children:`Amount`}),(0,g.jsxs)(`div`,{className:i(`flex items-center border-2 rounded-xl overflow-hidden transition-colors duration-200 transition-apple`,A?`border-status-error`:`border-border-primary focus-within:border-accent-blue`),children:[(0,g.jsxs)(`div`,{className:`relative`,children:[(0,g.jsxs)(`button`,{type:`button`,onClick:()=>E(e=>!e),className:`flex items-center gap-1.5 px-4 py-3.5 bg-surface-secondary/50 text-sm font-semibold text-text-primary hover:bg-surface-secondary transition-apple border-r border-border-primary`,children:[(0,g.jsx)(`span`,{children:M.flag}),(0,g.jsx)(`span`,{children:M.code}),(0,g.jsx)(d,{className:`w-3 h-3 text-text-tertiary`})]}),(0,g.jsx)(o,{children:T&&(0,g.jsx)(s.div,{className:`absolute top-full left-0 mt-1 bg-surface-primary border border-border-primary rounded-xl shadow-lg z-10 overflow-hidden min-w-[180px]`,initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},children:t.map(e=>(0,g.jsxs)(`button`,{type:`button`,onClick:()=>{b(e.code),E(!1)},className:i(`w-full flex items-center gap-2 px-4 py-2.5 text-sm text-left hover:bg-surface-secondary transition-apple`,e.code===y&&`bg-accent-blue/5 text-accent-blue`),children:[(0,g.jsx)(`span`,{children:e.flag}),(0,g.jsx)(`span`,{className:`font-semibold`,children:e.code}),(0,g.jsx)(`span`,{className:`text-text-tertiary text-xs`,children:e.name})]},e.code))})})]}),(0,g.jsx)(`input`,{type:`number`,inputMode:`decimal`,placeholder:`0.00`,value:m,onChange:e=>v(e.target.value),className:`flex-1 px-4 py-3.5 text-lg font-bold text-text-primary bg-transparent outline-none tabular-nums [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`,"aria-label":`Transfer amount`})]}),(0,g.jsxs)(`div`,{className:`flex items-center justify-between mt-2`,children:[(0,g.jsxs)(`span`,{className:`text-xs text-text-tertiary flex items-center gap-1`,children:[(0,g.jsx)(p,{className:`w-3 h-3`}),` Available: `,(e=>new Intl.NumberFormat(`en-US`,{style:`currency`,currency:y,minimumFractionDigits:2}).format(e))(n)]}),(0,g.jsx)(o,{children:A&&(0,g.jsxs)(s.span,{initial:{opacity:0,x:10},animate:{opacity:1,x:0},exit:{opacity:0},className:`flex items-center gap-1 text-xs font-semibold text-status-error`,children:[(0,g.jsx)(l,{className:`w-3 h-3`}),` Insufficient funds`]})})]})]}),(0,g.jsxs)(`div`,{className:`mb-5`,children:[(0,g.jsx)(`label`,{className:`text-xs font-medium text-text-secondary mb-1.5 block`,children:`Recipient`}),(0,g.jsxs)(`div`,{className:`relative`,children:[(0,g.jsxs)(`button`,{type:`button`,onClick:()=>O(e=>!e),className:i(`w-full flex items-center gap-2.5 pl-10 pr-4 py-3 text-sm font-medium rounded-xl border-2 bg-surface-primary transition-apple text-left`,D?`border-accent-blue`:`border-border-primary`,x?`text-text-primary`:`text-text-tertiary`),children:[(0,g.jsx)(f,{className:`absolute left-3.5 w-4 h-4 text-text-tertiary shrink-0`}),(0,g.jsx)(`span`,{className:`flex-1 truncate`,children:N?`${N.name}${N.bank?` (${N.bank})`:``}`:`Select a recipient`}),(0,g.jsx)(d,{className:i(`w-4 h-4 text-text-tertiary shrink-0 transition-transform duration-200`,D&&`rotate-180`)})]}),(0,g.jsx)(o,{children:D&&(0,g.jsx)(s.div,{initial:{opacity:0,y:-6,scale:.98},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-6,scale:.98},transition:{duration:.15},className:`absolute z-20 w-full mt-1.5 bg-surface-primary border border-border-primary rounded-xl shadow-lg overflow-hidden`,children:e.map(e=>(0,g.jsxs)(`button`,{type:`button`,onClick:()=>{S(e.id),O(!1)},className:i(`w-full flex items-center gap-3 px-4 py-2.5 text-sm text-left transition-colors`,e.id===x?`bg-accent-blue/10 text-accent-blue font-medium`:`text-text-primary hover:bg-surface-secondary`),children:[(0,g.jsx)(`div`,{className:`w-7 h-7 rounded-full bg-surface-secondary flex items-center justify-center shrink-0 text-xs font-bold text-text-secondary`,children:e.name[0]}),(0,g.jsxs)(`div`,{className:`min-w-0`,children:[(0,g.jsx)(`p`,{className:`font-medium truncate`,children:e.name}),e.bank&&(0,g.jsx)(`p`,{className:`text-xs text-text-tertiary`,children:e.bank})]})]},e.id))})})]})]}),(0,g.jsxs)(`div`,{className:`mb-6`,children:[(0,g.jsx)(`label`,{className:`text-xs font-medium text-text-secondary mb-1.5 block`,children:`Concept (optional)`}),(0,g.jsx)(`input`,{type:`text`,placeholder:`e.g., Rent payment`,value:C,onChange:e=>w(e.target.value),maxLength:100,className:`w-full px-4 py-3 text-sm rounded-xl border-2 border-border-primary bg-surface-primary text-text-primary focus:border-accent-blue outline-none transition-apple focus-visible:ring-2 focus-visible:ring-accent-blue`})]}),(0,g.jsxs)(s.button,{type:`submit`,disabled:!j,className:i(`w-full flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl text-sm font-bold transition-apple focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-blue`,j?`bg-accent-blue text-white hover:bg-accent-blue-hover active:bg-accent-blue-active`:`bg-surface-secondary text-text-tertiary cursor-not-allowed`),whileTap:j?{scale:.98}:{},children:[`Continue `,(0,g.jsx)(u,{className:`w-4 h-4`})]})]})},v.displayName=`TransferForm`,v.__docgenInfo={description:``,methods:[],displayName:`TransferForm`,props:{recipients:{required:!1,tsType:{name:`Array`,elements:[{name:`TransferRecipient`}],raw:`TransferRecipient[]`},description:``,defaultValue:{value:`[]`,computed:!1}},currencies:{required:!1,tsType:{name:`Array`,elements:[{name:`CurrencyOption`}],raw:`CurrencyOption[]`},description:``,defaultValue:{value:`[
