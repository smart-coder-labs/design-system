import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-CmoObUFa.js";import{Zn as r,Zt as i,er as a,mn as o,qn as s,t as c,tt as l}from"./lucide-react-Dg7gJGVx.js";import{t as u}from"./jsx-runtime-DaLCRA3n.js";import{s as d,t as f}from"./es-Bjq_ogfB.js";var p,m,h,g=e((()=>{p=t(n()),f(),c(),m=u(),h=({initialScore:e=650})=>{let[t,n]=(0,p.useState)(e),[c,u]=(0,p.useState)([]),f=[{id:`1`,title:`Pagar a tiempo (3 meses)`,impact:15,icon:s,type:`positive`},{id:`2`,title:`Aumentar Límite (+20%)`,impact:8,icon:r,type:`positive`},{id:`3`,title:`Nuevo Préstamo Auto`,impact:-12,icon:i,type:`negative`},{id:`4`,title:`Atraso de 30 días`,impact:-45,icon:a,type:`negative`}],h=e=>{u([...c,t]),n(Math.min(850,Math.max(300,t+e)))},g=()=>{n(e),u([])},_=(e=>e>=750?{label:`Excelente`,color:`bg-status-success`,text:`text-status-success`,bg:`bg-status-success/10 text-status-success border-status-success/20`}:e>=680?{label:`Bueno`,color:`bg-accent-blue`,text:`text-accent-blue`,bg:`bg-accent-blue-tint text-accent-blue border-accent-blue/20`}:e>=620?{label:`Regular`,color:`bg-status-warning`,text:`text-status-warning`,bg:`bg-status-warning/10 text-status-warning border-status-warning/20`}:e>=550?{label:`Malo`,color:`bg-status-error`,text:`text-status-error`,bg:`bg-status-error/10 text-status-error border-status-error/20`}:{label:`Pobre`,color:`bg-status-error`,text:`text-status-error`,bg:`bg-status-error/10 text-status-error border-status-error/20`})(t),v=t-e,y=Math.max(0,Math.min(100,(t-300)/550*100));return(0,m.jsxs)(`div`,{className:`bg-surface-primary border border-border-primary p-6 rounded-3xl max-w-sm mx-auto shadow-sm`,children:[(0,m.jsxs)(`div`,{className:`flex justify-between items-center mb-6`,children:[(0,m.jsxs)(`h3`,{className:`font-bold text-text-primary flex items-center gap-2`,children:[(0,m.jsx)(o,{className:`text-accent-blue`}),`Simulador Crediticio`]}),c.length>0&&(0,m.jsxs)(`button`,{onClick:g,className:`text-xs font-semibold text-text-tertiary hover:text-text-primary flex items-center gap-1 transition-colors bg-background-secondary px-2 py-1 rounded-md`,children:[(0,m.jsx)(l,{size:12}),` Reiniciar`]})]}),(0,m.jsxs)(`div`,{className:`relative flex justify-center mb-8 h-40 overflow-hidden`,children:[(0,m.jsxs)(`svg`,{viewBox:`0 0 200 100`,className:`w-56 overflow-visible absolute inset-x-0 mx-auto mt-4`,children:[(0,m.jsx)(`path`,{d:`M 20 90 A 70 70 0 0 1 180 90`,fill:`none`,stroke:`currentColor`,strokeWidth:`16`,strokeLinecap:`round`,className:`text-border-primary`}),(0,m.jsx)(d.path,{d:`M 20 90 A 70 70 0 0 1 180 90`,fill:`none`,stroke:`currentColor`,strokeWidth:`16`,strokeLinecap:`round`,strokeDasharray:`220`,initial:{strokeDashoffset:220},animate:{strokeDashoffset:220-220*y/100},transition:{type:`spring`,stiffness:40,damping:10},className:_.text})]}),(0,m.jsxs)(`div`,{className:`absolute bottom-2 flex flex-col items-center`,children:[(0,m.jsx)(d.div,{initial:{scale:.8,opacity:0},animate:{scale:1,opacity:1},className:`text-4xl font-black text-text-primary tracking-tighter`,children:t},t),(0,m.jsx)(`div`,{className:`mt-1 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full border ${_.bg}`,children:_.label})]})]}),v!==0&&(0,m.jsxs)(d.div,{initial:{y:10,opacity:0},animate:{y:0,opacity:1},className:`text-center font-bold text-sm mb-6 ${v>0?`text-status-success`:`text-status-error`}`,children:[`El puntaje `,v>0?`subiría`:`bajaría`,` `,Math.abs(v),` pt(s).`]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`p`,{className:`text-xs uppercase tracking-wider font-bold text-text-tertiary mb-3 px-1`,children:`¿Qué pasaría si...?`}),(0,m.jsx)(`div`,{className:`space-y-2`,children:f.map(e=>{let t=e.icon;return(0,m.jsxs)(`button`,{onClick:()=>h(e.impact),className:`w-full text-left p-3 rounded-xl border transition-all flex justify-between items-center group
