import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as i}from"./iframe-ChONrTG_.js";import{c as m}from"./utils-CDN07tui.js";import{m as k}from"./proxy-CRCEyvcV.js";import{C as B}from"./clock-aZk4Lvps.js";import{A as G}from"./index-DyeVvxBP.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-elements-juiWZL7b.js";import"./createLucideIcon-CdJ-Xkq_.js";const J=a=>{if(!a)return null;const[s,n]=a.split(":").map(Number);return isNaN(s)||isNaN(n)||s<0||s>23||n<0||n>59?null:{hours:s,minutes:n}},E=(a,s,n)=>{const u=s.toString().padStart(2,"0");if(n==="24h")return`${a.toString().padStart(2,"0")}:${u}`;{const c=a>=12?"PM":"AM";return`${a%12||12}:${u} ${c}`}},K=`
  w-full
  bg-surface-primary
