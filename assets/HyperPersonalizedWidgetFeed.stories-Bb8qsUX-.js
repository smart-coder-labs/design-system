import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{a as n}from"./iframe-DL3IwwZJ.js";import{t as r}from"./jsx-runtime-BK76Wfr-.js";import{s as i,t as a}from"./es-CnNtA5mJ.js";import{Et as o,Nn as s,ar as c,cn as l,ir as u,q as d,t as f,ut as p}from"./lucide-react-C3ayLXpj.js";var m,h,g,_=e((()=>{m=t(n()),a(),f(),h=r(),g=({initialWidgets:e=[{id:`w1`,title:`Saldo Principal`,type:`balance`,visible:!0,order:1},{id:`w2`,title:`Análisis de Gastos`,type:`spending`,visible:!0,order:2},{id:`w3`,title:`Portafolio Cripto`,type:`crypto`,visible:!1,order:3},{id:`w4`,title:`Metas de Ahorro`,type:`savings`,visible:!0,order:4}]})=>{let[t,n]=(0,m.useState)(e),[r,a]=(0,m.useState)(!1),f=e=>{n(t.map(t=>t.id===e?{...t,visible:!t.visible}:t))},g=t.filter(e=>e.visible).sort((e,t)=>e.order-t.order),_=t.filter(e=>!e.visible).sort((e,t)=>e.order-t.order),v=e=>{switch(e){case`balance`:return(0,h.jsxs)(`div`,{className:`flex justify-between items-end p-4 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl text-white shadow-lg`,children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`p`,{className:`text-xs font-semibold uppercase tracking-wider text-blue-100 mb-1`,children:`Cuentas`}),(0,h.jsx)(`h3`,{className:`text-3xl font-black tracking-tight`,children:`$45,200.00`})]}),(0,h.jsx)(s,{size:32,className:`opacity-30`})]});case`spending`:return(0,h.jsxs)(`div`,{className:`p-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-sm text-gray-900 dark:text-white`,children:[(0,h.jsxs)(`div`,{className:`flex justify-between items-center mb-3`,children:[(0,h.jsx)(`h4`,{className:`font-semibold text-sm`,children:`Gastos del mes`}),(0,h.jsx)(u,{size:16,className:`text-gray-400`})]}),(0,h.jsx)(`div`,{className:`h-2 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden`,children:(0,h.jsx)(`div`,{className:`h-full bg-red-500 w-[70%]`})}),(0,h.jsx)(`p`,{className:`text-xs text-gray-500 mt-2`,children:`Has gastado el 70% de tu presupuesto.`})]});case`crypto`:return(0,h.jsxs)(`div`,{className:`p-4 bg-black rounded-xl text-white shadow-sm border border-gray-800`,children:[(0,h.jsxs)(`div`,{className:`flex justify-between items-center mb-3`,children:[(0,h.jsx)(`h4`,{className:`font-semibold text-sm`,children:`Criptomonedas`}),(0,h.jsx)(c,{size:16,className:`text-emerald-400`})]}),(0,h.jsx)(`p`,{className:`text-xl font-bold font-mono`,children:`0.054 BTC`}),(0,h.jsx)(`p`,{className:`text-xs text-emerald-400 mt-1 flex items-center gap-1`,children:`+2.4% hoy`})]});default:return(0,h.jsxs)(`div`,{className:`p-4 bg-emerald-50 dark:bg-emerald-900 border border-emerald-100 dark:border-emerald-800 rounded-xl shadow-sm text-emerald-900 dark:text-emerald-300`,children:[(0,h.jsx)(`h4`,{className:`font-semibold text-sm mb-1`,children:`Ahorro Automático`}),(0,h.jsx)(`p`,{className:`text-2xl font-bold`,children:`$1,250.50`})]})}};return(0,h.jsxs)(`div`,{className:`max-w-md mx-auto relative rounded-3xl bg-gray-50 dark:bg-black p-4 min-h-[500px] border border-gray-200 dark:border-gray-800 overflow-hidden`,children:[(0,h.jsxs)(`div`,{className:`flex justify-between items-center mb-6 px-2`,children:[(0,h.jsx)(`h2`,{className:`text-lg font-bold text-gray-900 dark:text-white`,children:`Resumen`}),(0,h.jsx)(`button`,{onClick:()=>a(!r),className:`p-2 rounded-full transition-colors ${r?`bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-50`:`bg-white text-gray-500 dark:bg-gray-900 dark:text-gray-400 border border-gray-200 dark:border-gray-800`}`,children:(0,h.jsx)(d,{size:18})})]}),(0,h.jsxs)(`div`,{className:`space-y-4 relative`,children:[g.map((e,t)=>(0,h.jsxs)(i.div,{layout:!0,initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`flex items-center gap-2`,children:[r&&(0,h.jsxs)(`div`,{className:`flex gap-1 items-center shrink-0`,children:[(0,h.jsx)(`div`,{className:`cursor-grab active:cursor-grabbing text-gray-400 p-1 hover:text-gray-600 dark:hover:text-gray-300`,children:(0,h.jsx)(l,{size:16})}),(0,h.jsx)(`button`,{onClick:()=>f(e.id),className:`w-6 h-6 rounded-full bg-red-500 text-white flex items-center justify-center hover:bg-red-600`,children:(0,h.jsx)(o,{size:14})})]}),(0,h.jsx)(`div`,{className:`flex-1 min-w-0`,children:v(e.type)})]},e.id)),r&&_.length>0&&(0,h.jsxs)(i.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:`mt-8 pt-6 border-t border-dashed border-gray-300 dark:border-gray-700`,children:[(0,h.jsx)(`h3`,{className:`text-xs font-bold uppercase tracking-wider text-gray-400 mb-4 px-2`,children:`Widgets Inactivos`}),(0,h.jsx)(`div`,{className:`space-y-3`,children:_.map(e=>(0,h.jsxs)(`div`,{className:`flex justify-between items-center p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800`,children:[(0,h.jsx)(`span`,{className:`text-sm font-medium text-gray-600 dark:text-gray-300`,children:e.title}),(0,h.jsx)(`button`,{onClick:()=>f(e.id),className:`w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center hover:bg-blue-600`,children:(0,h.jsx)(p,{size:14})})]},e.id))})]})]})]})},g.__docgenInfo={description:``,methods:[],displayName:`HyperPersonalizedWidgetFeed`,props:{initialWidgets:{required:!1,tsType:{name:`Array`,elements:[{name:`WidgetData`}],raw:`WidgetData[]`},description:``,defaultValue:{value:`[
