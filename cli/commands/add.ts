...
export const add = async (components: string[]) => {
  ...
  for (const component of components) {
    ...
    if (source.includes('framer-motion')) dependenciesToInstall.add('framer-motion');
    if (source.includes('lucide-react')) dependenciesToInstall.add('lucide-react');
    if (source.includes('clsx')) dependenciesToInstall.add('clsx');
    if (source.includes('tailwind-merge')) dependenciesToInstall.add('tailwind-merge');
    if (source.includes('class-variance-authority')) dependenciesToInstall.add('class-variance-authority');
    ...
    try {
        ...
        regDeps.forEach((dep: string) => dependenciesToInstall.add(dep));
    } catch {
