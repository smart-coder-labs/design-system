...
export const StepLineChart: React.FC<StepLineChartProps> = ({
  data,
  series,
  className,
  size = 'md',
  ...
  // Step-after path: horizontal first, then vertical
  ...
  const ariaLabel = title
    ? `${title} step line chart with ${series.length} series and ${data.length} data points`
    : `Step line chart with ${series.length} series and ${data.length} data points`;
