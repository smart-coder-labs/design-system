...
export const RecurringInvestConfigurator: React.FC<RecurringInvestConfiguratorProps> = ({
    ...
    return (
        <div className={cn("w-full max-w-sm bg-white dark:bg-zinc-900 rounded-[2rem] p-6 shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden relative", className)}>
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Auto-Invest</h3>
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">Dollar Cost Averaging</p>
                </div>
            </div>
            ...
            <div className="relative min-h-[300px]">
                <AnimatePresence mode="wait">
                    {step === 1 && (
                        ...
                        >
                            <div className="space-y-3">
                                <label className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 block">I want to buy</label>
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                asset === a.id
                                                    ...
                                                    : "border-zinc-200 dark:border-zinc-700 hover:border-zinc-300 shadow-sm text-zinc-900 dark:text-zinc-100"
                                            )}
                                        >
                            ...
                            <div className="space-y-3">
                                <label className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 block">Amount</label>
                    ...
                    {step === 2 && (
                        ...
                        >
                            <div className="space-y-3">
                                <label className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 block flex items-center gap-2">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {frequencies.map((f) => (
                                        ...
                                        >
                                            <div className="font-bold text-zinc-900 dark:text-zinc-100">{f.label}</div>
