...
export const FullWidth: Story = {
  ...
  render: () => (
    <div className="w-80 flex flex-col gap-3 p-4 bg-surface-primary rounded-xl border border-border-primary">
      ...
      <Button variant="outline" fullWidth onClick={action('create-account')}>Create Account</Button>
    </div>
  ),
};
...
export const ActionRow: Story = {
  render: () => (
    <div className="flex items-center gap-3">
      ...
      <Button variant="secondary" leftIcon={<Plus className="w-4 h-4" />} onClick={action('add')}>Add Item</Button>
