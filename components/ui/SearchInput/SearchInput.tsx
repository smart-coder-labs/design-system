            ...
            (e: React.KeyboardEvent<HTMLInputElement>): boolean => {
                ...
                switch (e.key) {
                    ...
                    case 'Enter': {
                        ...
                        // Items rendered without `onClick` are plain divs: activating them
                        // is a no-op, so let Enter fall through to the onSearch fallback
                        if (!(activeOption instanceof HTMLButtonElement)) return false;
                        e.preventDefault();
                        activeOption.click();
                        return true;
                    }
