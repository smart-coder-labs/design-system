        ...
        >
            ...
            <div className="flex items-center gap-4 overflow-x-auto pb-2 scrollbar-hide">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                >
                    <div className="w-14 h-14 rounded-full border-2 border-dashed border-border-primary flex items-center justify-center text-text-tertiary hover:border-accent-blue hover:text-accent-blue transition-colors">
                ...
                {contacts.map((contact, i) => (
                    ...
                    >
                        ...
                        <span className="text-[10px] font-medium text-text-secondary w-14 text-center truncate group-hover:text-text-primary transition-colors">
