...
export const FintechDashboardPreview: React.FC<FintechDashboardPreviewProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<'home' | 'cards' | 'transfers' | 'invest' | 'settings'>('home');

    const tabs: { id: 'home' | 'cards' | 'transfers' | 'invest' | 'settings'; label: string; icon: React.ReactNode }[] = [
