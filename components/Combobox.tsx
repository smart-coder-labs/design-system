        ...
        <PopoverPrimitive.Root open={open} onOpenChange={setOpen}>
            ...
            <PopoverPrimitive.Portal>
                <PopoverPrimitive.Content
                    className={cn(
                        "relative z-50 min-w-[var(--radix-popover-trigger-width)] overflow-hidden rounded-xl border border-border-primary bg-surface-glass backdrop-blur-xl text-text-primary shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
                        "p-0"
                    )}
                    align="start"
                    sideOffset={4}
