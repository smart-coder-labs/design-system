...
const meta: Meta = {
  title: 'Cyberpunk/02 - Micro-Interactions & UI',
  parameters: {
    layout: 'centered',
  },
};
...
export const UIComponentsShowcase: StoryObj = {
  render: () => (
    <div className="bg-void-black min-h-screen w-full p-20 flex flex-col items-center gap-32 text-white overflow-hidden perspective-1000">
      ...
      <div className="flex flex-col items-center gap-6 w-full max-w-5xl">
        ...
        <div className="flex flex-wrap justify-center gap-12 perspective-1000">
          <HolographicCard 
            title="Firewall Subroutines" 
            description="Algoritmos de defensa reactiva que detectan intrusiones hostiles en nanosegundos. El glare reacciona a tu linterna holográfica cerebral."
            icon={<span className="text-5xl">🛡️</span>}
          />
          <HolographicCard 
            title="Fatal Error" 
            description="Motor termonuclear inestable. Si los niveles de radiación bajan de cero, el sistema colapsará."
      ...
      <div className="flex flex-col items-center gap-6 w-full max-w-3xl border border-industrial-grey p-10 bg-[rgba(10,10,10,0.8)] backdrop-blur-md">
        ...
        <TerminalAccordion 
          question="¿POR QUÉ LOS ENGRANAJES ESTÁN DETENIDOS?"
          answer="El sistema detectó un parásito lógico en la red de suministro principal. Todas las rotaciones han sido congeladas (await) para prevenir la corrupción del frontend."
        />
        <TerminalAccordion 
          question="INICIAR SECUENCIA DE PURGA DE MEMORIA"
          answer="ADVERTENCIA: Destruir el caché borrará el progreso guardado y despertará los procesos huérfanos. Pulsa (y) para confirmar o espera hasta el fin de ciclo."
        />
        <TerminalAccordion 
          question="MOSTRAR LICENCIA DEL VECTOR"
          answer="Propiedad Intelectual de The Spark Corp. Acceso no autorizado revocado. Desconectando interfaz visual..."
        />
      </div>
    </div>
  ),
