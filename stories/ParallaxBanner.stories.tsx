...
const meta = {
  ...
  decorators: [
    (Story) => (
      <div className="bg-neutral-900 min-h-[150vh] text-white">
        <div className="h-[60vh] flex items-center justify-center p-8 text-center text-gray-400">
  ...
  args: {
    ...
    children: (
      <div className="py-20">
        ...
        <p className="text-xl text-white/80 max-w-xl mx-auto">Explore the unknown with tools designed to take you further.</p>
      </div>
    )
  },
};
