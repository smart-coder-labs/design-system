  ...
  decorators: [
    (Story) => (
      <div className="min-h-[200vh]">
        <div className="h-[80vh] flex items-center justify-center border-b border-border-primary">
          <p className="text-xl text-text-tertiary">Scroll down to reveal cards ↓</p>
        </div>
        <Story />
      </div>
    ),
