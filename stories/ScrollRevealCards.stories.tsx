...
const meta = {
  ...
  decorators: [
    (Story) => (
      <div className="bg-white dark:bg-neutral-900 min-h-[200vh] text-zinc-900 dark:text-zinc-50">
        <div className="h-[80vh] flex items-center justify-center border-b border-zinc-200 dark:border-white/10">
