...
import { DensityPlot } from '../../components/ui/charts/DensityPlot';
...
const meta: Meta<typeof DensityPlot> = {
  title: 'Charts/DensityPlot',
...
export default meta;
type Story = StoryObj<typeof DensityPlot>;
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-6">
      {(['default', 'glass', 'bordered', 'elevated'] as const).map(v => (
        <DensityPlot key={v} data={sampleData} variant={v} title={v} />
      ))}
    </div>
  ),
};
